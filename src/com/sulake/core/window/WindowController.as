package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_776:Function;
      ...
      {
         return this.var_776 != null ? this.var_776 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_959);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_537,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_349 = this._parent.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_446,this,this._parent));
            }
            else
            {
               this.var_349.x = 0;
               this.var_349.y = 0;
               this.var_349.width = 0;
               this.var_349.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1004,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_19,var_15,var_11,null,this.var_776,this.properties,var_773.concat(),_id) as WindowController;
         _loc2_.var_421 = var_421;
         _loc2_.var_153 = this.var_153;
         _loc2_._debug = this._debug;
         _loc2_.var_349 = this.var_349.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2622 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_73);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_447)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_910,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_615,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_177,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_38:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_960;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_177:
                  var_15.invalidate(this,var_11.union(var_56),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_427,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_142))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_187,WindowParam.const_151))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
               ...
               case WindowNotifyEvent.const_521:
                  var_15.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_442);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1050,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_379:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_624,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_204,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_537:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_998);
                  break;
               ...
               case WindowNotifyEvent.const_427:
                  this._parent.getRegionProperties(null,this.var_349);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_953:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1522:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1459:
               _loc2_ = "null";
               break;
         ...
         if(this.var_153 && var_421 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1426,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1426,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_142);
         var _loc2_:* = !testParamFlag(WindowParam.const_119,WindowParam.const_151);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_349.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_349.height;
               _loc5_ = uint(var_19 & 0);
      ...
      {
         if(_state == WindowState.const_419)
         {
            return true;
         }
         _state = WindowState.const_419;
      ...
      public function maximize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_61,true);
         _loc1_.type = WindowNotifyEvent.const_1098;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_379;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_783;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1425 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_327,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1425 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_714,this,param1));
         return param1;
      }
