package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_172;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_78 = param1.var_1168 as WindowController;
         this._lastClickTarget = param1.var_1166 as WindowController;
         this.var_143 = param1.renderer;
         this.var_771 = param1.var_1169;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_630.x || _loc3_.stageY != this.var_630.y)
            {
               this.var_630.x = _loc3_.stageX;
               this.var_630.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_131.groupParameterFilteredChildrenUnderPoint(this.var_630,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_78 != this.var_131 && !this.var_78.disposed)
                  {
                     ...
                     this.var_78 = WindowController(this.var_131);
                  }
               }
            }
            while(--_loc4_ > -1)
         ...
         param1.var_1168 = this.var_78;
         param1.var_1166 = this._lastClickTarget;
         param1.renderer = this.var_143;
         param1.var_1169 = this.var_771;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_504))
         {
