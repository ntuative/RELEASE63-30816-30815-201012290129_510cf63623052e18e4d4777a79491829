package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_973:String = "_EXCLUDE";
      
      public static const const_1769:String = "_INCLUDE";
      
      public static const const_1726:String = "_TEMP";
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1189);
         this.var_949 = new Dictionary();
         this.var_1436 = new Dictionary();
         ParamCodeTable.fillTables(this.var_949,this.var_1436);
         this.var_1914 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1242,"");
         return param1.replace(const_1243,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1189)
            {
               delete this.var_1189[_loc1_];
            }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1189[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_973) == -1)
                  {
