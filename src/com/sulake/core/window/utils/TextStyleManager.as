package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_362:String = "regular";
      ...
      private static var var_217:IEventDispatcher;
      
      private static const TAG_OPEN:String = "{";
      
      private static const const_555:String = "}";
      ...
      private static function init() : void
      {
         var _loc1_:* = null;
         var_82 = new Map();
         var_217 = new EventDispatcher();
         _loc1_ = new TextStyle();
         _loc1_.name = const_362;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            var_217.dispatchEvent(new Event(Event.ADDED));
         }
         else
         {
            var_217.dispatchEvent(new Event(Event.CHANGE));
         }
      }
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_362],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_362] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_555);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_555))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_555 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1209) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1208) + 2,_loc5_.length);
            }
