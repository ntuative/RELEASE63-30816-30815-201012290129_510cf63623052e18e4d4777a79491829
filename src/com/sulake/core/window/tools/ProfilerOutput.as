package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1294:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1293:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_880 = param3;
         var _loc4_:ByteArray = new var_1294() as ByteArray;
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_676)
            {
               this.var_1619 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      public function refresh(param1:Event) : void
      {
         ...
         if(this.var_1619)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_141.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_141.numBitmapAssetInstances + " / " + this.var_141.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_880.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_141.numTrackedBitmapDataInstances + " / " + this.var_141.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1293() as ByteArray;
