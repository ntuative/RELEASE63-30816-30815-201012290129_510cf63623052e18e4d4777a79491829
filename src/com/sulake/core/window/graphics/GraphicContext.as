package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1814:uint = 64;
      
      public static const const_1777:uint = 128;
      ...
      protected var var_1915:Boolean;
      
      protected var var_775:Boolean;
         ...
         if(this.var_775)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1915,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1915,16777215);
                  }
                  var_294 += bitmap.width * bitmap.height * 4;
               }
