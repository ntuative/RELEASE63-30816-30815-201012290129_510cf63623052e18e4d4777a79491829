package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_850:uint = 8;
      
      private static const const_1183:String = "skin";
      
      private static const const_1184:String = "bitmap";
      
      private static const const_1185:String = "fill";
      
      private static const const_1181:String = "text";
      
      private static const const_1179:String = "shape";
      
      private static const const_1180:String = "unknown";
      
      private static const const_1182:String = "null";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2225 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1612,this.var_2225);
         this.var_2226 = new Dictionary();
         this.var_2224 = new Dictionary();
         StateCodeTable.fillTables(this.var_2226,this.var_2224);
         this.var_465 = new Dictionary();
         this.var_465[const_1183] = BitmapSkinRenderer;
         this.var_465[const_1184] = BitmapDataRenderer;
         this.var_465[const_1185] = FillSkinRenderer;
         this.var_465[const_1181] = TextSkinRenderer;
         this.var_465[const_1179] = ShapeSkinRenderer;
         this.var_465[const_1180] = SkinRenderer;
         this.var_465[const_1182] = NullSkinRenderer;
         if(var_293 == null)
         {
            var_293 = new Array();
            var_293.push(WindowState.const_61);
            var_293.push(WindowState.const_74);
            var_293.push(WindowState.const_83);
            var_293.push(WindowState.const_46);
            var_293.push(WindowState.WINDOW_STATE_HOVERING);
            var_293.push(WindowState.const_79);
            var_293.push(WindowState.const_95);
            var_293.push(WindowState.const_91);
         }
         if(param1 != null)
         {
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_846[param1] = new Array(const_850);
         }
         this.var_846[param1][param2] = param3;
         if(this.var_847[param1] == null)
         {
            this.var_847[param1] = new Array(const_850);
         }
         this.var_847[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_296)
            {
               _loc4_ = _loc3_["null"];
            }
         }
