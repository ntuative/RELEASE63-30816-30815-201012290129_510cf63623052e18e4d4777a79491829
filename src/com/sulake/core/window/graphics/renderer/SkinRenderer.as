package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_353:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_512)
            {
               ISkinLayout(this.var_512[_loc1_]).dispose();
               delete this.var_512[_loc1_];
            }
            this.var_512 = null;
            this.var_418 = null;
            for(_loc1_ in this.var_353)
            {
               ISkinTemplate(this.var_353[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinLayout = this.var_512[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = this.var_353[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_512[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_353[param1.name];
         if(param1 != null)
         {
            ...
            delete this.var_512[param1.name];
         }
         return param1;
      }
      ...
      {
         this.var_353[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_353[param1.name];
         }
         return param1;
      }
   }
