package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_767:Dictionary;
      ...
      {
         super(param1);
         this.var_767 = new Dictionary(false);
         this.var_768 = new Dictionary(false);
         this.var_789 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_789 = null;
            for(_loc1_ in this.var_767)
            {
               _loc2_ = this.var_767[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_767[_loc1_];
            }
            this.var_767 = null;
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_455)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_455)
                  {
                     _loc15_ = true;
                  ...
                  {
                     this.var_789.a = _loc13_.width / _loc19_.width;
                     this.var_789.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,this.var_789);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,this.var_789,null);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_767[_loc3_];
         if(_loc4_ == null)
         {
