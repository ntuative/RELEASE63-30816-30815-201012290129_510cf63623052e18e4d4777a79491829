package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_176:ISelectableWindow;
      
      protected var var_1910:Boolean = true;
      ...
      {
         return this.var_176 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_176)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_325,this,this.var_176));
               }
            }
         }
      }
