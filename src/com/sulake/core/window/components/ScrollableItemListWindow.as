package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_408)
         {
            this.var_408.removeEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            this.var_408.removeEventListener(WindowEvent.const_251,this.scrollBarEventProc);
            this.var_408 = null;
         }
         if(this.var_1154)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1154)
         {
            this.var_1154 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_408)
         {
            ...
            if(this.var_408)
            {
               this.var_408.addEventListener(WindowEvent.const_305,this.scrollBarEventProc);
               this.var_408.addEventListener(WindowEvent.const_251,this.scrollBarEventProc);
            }
         }
         return this.var_408;
      }
