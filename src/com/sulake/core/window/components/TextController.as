package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_769:Number;
      
      protected var var_511:Number;
      ...
      protected var var_946:Boolean = false;
      
      private var var_375:String = "regular";
      
      private var var_193:TextStyle;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_375,this.var_193);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_193.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_193.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_193.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_193.fontSize = param2;
      }
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_116)
         {
            param1.context.removeLocalizationListener(param1.var_36,param1);
            param1.var_116 = false;
         }
         param1.var_36 = param2;
         if(param1.var_36.charAt(0) == "$" && param1.var_36.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_36.slice(2,param1.var_36.indexOf("}")),param1);
            param1.var_116 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_36;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_193.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_193.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_375 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_375,param1.var_193);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_193.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_362);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1109 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_375);
      }
      ...
      {
         this.var_769 = param1;
         this._field.scrollH = this.var_769 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_769 * this.maxScrollH,this.var_511 * this.maxScrollV,width,height);
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         if(this.var_116)
         {
            context.removeLocalizationListener(var_36,this);
            this.var_116 = false;
         }
         var_36 = param1;
         if(var_36.charAt(0) == "$" && var_36.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_36.slice(2,var_36.indexOf("}")),this);
            this.var_116 = true;
         }
         else if(this._field != null)
         {
            this._field.text = var_36;
            this.refreshTextImage();
         }
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_510)
         {
            if(param2.type == WindowNotifyEvent.const_177)
            {
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_375);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_85,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_304,this.defaultTextFormat.size != _loc2_.fontSize));
         ...
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_85,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1532));
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_47,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_47,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_161,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_47,this._field.condenseWhite != false));
         _loc1_.push(new PropertyStruct("display_as_password",this._field.displayAsPassword,PropertyStruct.const_47,this._field.displayAsPassword != false));
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_85,this._field.gridFitType != GridFitType.PIXEL,const_1530));
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_52,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",this._field.mouseWheelEnabled,PropertyStruct.const_47,this._field.mouseWheelEnabled != false));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_47,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_85,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_244,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_375,PropertyStruct.const_85,this.var_375 != TextStyleManager.const_362,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_244,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_47,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_77.left,PropertyStruct.const_52,this.var_77.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_77.top,PropertyStruct.const_52,this.var_77.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_77.right,PropertyStruct.const_52,this.var_77.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_77.bottom,PropertyStruct.const_52,this.var_77.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_415,PropertyStruct.const_85,this.var_415 != TextFieldAutoSize.NONE,const_1531));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_47,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_47,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_47,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_47,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
