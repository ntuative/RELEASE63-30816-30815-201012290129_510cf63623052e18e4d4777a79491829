package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1135:String = "_SELECTOR";
      
      private static const const_1136:String = "_CONTENT";
       
      
      protected var var_941:ITabSelectorWindow;
      
      protected var var_1893:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_941 = findChildByTag(const_1135) as ITabSelectorWindow;
            if(this.var_941 != null)
            {
               this.var_941.procedure = this.selectorEventProc;
            }
         }
         return this.var_941;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1893 = findChildByTag(const_1136) as IWindowContainer;
         }
      ...
      {
         return !!this.var_664 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_941.numSelectables;
      }
