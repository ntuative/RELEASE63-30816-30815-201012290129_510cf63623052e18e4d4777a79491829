package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1214:String = "increment";
      
      private static const const_1215:String = "decrement";
      
      private static const const_864:String = "slider_track";
      
      private static const const_557:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_153 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_532;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_542,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_45,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_542,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_864) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_557) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_557:
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_38 || param1.type == WindowTouchEvent.const_400)
         {
            ...
            else if(param2.name == const_1215)
            {
               if(this.var_18)
               {
                  this.var_1078 = true;
            ...
            else if(param2.name == const_864)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_557).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
