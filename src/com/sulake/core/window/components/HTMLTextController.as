package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static const const_840:Array = [LinkTarget.const_31,LinkTarget.const_1513,LinkTarget.PARENT,LinkTarget.SELF,LinkTarget.TOP];
       
      
      private var var_811:String = null;
      ...
      {
         return this.var_811 == LinkTarget.const_31 ? defaultLinkTarget : this.var_811;
      }
      ...
      override public function set text(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_36);
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("link_target",this.var_811,PropertyStruct.const_85,this.var_811 != null,const_840));
         return _loc1_;
      }
