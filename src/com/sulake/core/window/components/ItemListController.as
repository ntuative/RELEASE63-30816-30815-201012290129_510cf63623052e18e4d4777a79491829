package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1123:String = "spacing";
      
      protected static const const_1122:String = "scale_to_fit_items";
      
      protected static const const_1124:String = "resize_on_item_update";
      
      protected static const const_1121:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1536:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1535:Boolean = true;
       
      
      protected var var_629:Number;
      
      protected var var_628:Number;
      ...
      protected var var_1912:Boolean = false;
      ...
      protected var var_2697:Number = 0.0;
      
      protected var var_2698:Number = 0.0;
      
      protected var var_948:Boolean = true;
      
      protected var var_514:Boolean = false;
      
      protected var var_1186:Boolean = false;
      
      protected var var_1913:int = 0;
      
      protected var var_1911:int = 0;
      
      protected var var_1185:Number;
      
      protected var var_1187:Number;
      
      protected var var_1184:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_153 = var_420 || !testParamFlag(WindowParam.const_32);
         this._container = var_15.create("_CONTAINER","",WindowType.const_328,WindowStyle.const_744,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_45,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_509,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_294,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_425,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_629 * this.maxScrollH,this.var_628 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_629)
         {
            ...
            var_15.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_73);
            dispatchEvent(new WindowEvent(WindowEvent.const_542,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_628 = param1;
            this._container.y = -this.var_628 * this.maxScrollV;
            var_15.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_73);
            dispatchEvent(new WindowEvent(WindowEvent.const_542,this,null));
         }
      }
      ...
      {
         this.var_2697 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2698 = Math.max(param1,0);
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_509,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_294,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_425,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_181:
               if(this.var_1184)
               {
                  this.var_1185 = this.var_1913 - _loc3_;
                  this.var_1187 = this.var_1911 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1185 != 0 && this.var_100 != 0)
                     {
                        this.scrollH += this.var_1185 / this.var_100;
                     }
                  }
            ...
            case WindowMouseEvent.const_172:
               if(this.var_1184)
               {
                  if(this._horizontal)
                  {
                     var_15.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1185,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_948 && !this.var_513 && this._container)
         {
            this.var_513 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1123,this._spacing,PropertyStruct.const_52,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1121,this.var_948,PropertyStruct.const_47,this.var_948 != const_1535));
         _loc1_.push(new PropertyStruct(const_1122,this.var_514,PropertyStruct.const_47,this.var_514 != const_1536));
         _loc1_.push(new PropertyStruct(const_1124,this.var_1186,PropertyStruct.const_47,this.var_1186 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
