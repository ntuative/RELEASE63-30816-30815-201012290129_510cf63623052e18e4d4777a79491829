package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_517:Array;
      
      protected var var_947:LoaderContext;
      
      protected var var_422:AssetLibrary;
      
      protected var var_748:XML;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_422 = new AssetLibrary("lib-" + this.var_519++);
         this.var_27.push(this.var_422);
      }
      ...
      {
         return this.var_422.loadFromResource(param1,param2);
      }
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_517.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_517.length)
            {
               _loc3_ = this.var_517[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_517.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return this.var_422.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_422.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_422.createAsset(param1,param2);
      }
      ...
      {
         return this.var_422.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_422.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_422.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_27.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_422.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_27.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
