package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1082:String = "AssetLibraryReady";
      
      public static const const_749:String = "AssetLibraryLoaded";
      
      public static const const_1283:String = "AssetLibraryUnloaded";
      
      public static const const_1460:String = "AssetLibraryLoadError";
      
      private static var var_286:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_495:uint = 0;
      
      private static var var_915:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_748 = new XML();
         this.var_404 = 0;
         this.var_405 = new Array();
         if(var_286 == null)
         {
            var_286 = new Dictionary(false);
         ...
         ++var_495;
         this.var_406 = new Dictionary(false);
         this.var_496 = new Dictionary(false);
         this.var_916 = new Dictionary(false);
         this.var_149 = new Dictionary(false);
         var_915.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_915.splice(var_915.indexOf(this),1);
            --var_495;
            this.var_496 = null;
            this.var_916 = null;
            this.var_149 = null;
      ...
      {
         if(this._file == param1.url && this.var_917)
         {
            if(!this.var_914 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_748,this.var_610);
            }
            this.var_914 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1082));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_496)
         {
            _loc2_ = this.var_496[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_496[_loc1_];
         }
         for(_loc1_ in this.var_149)
         {
            delete this.var_149[_loc1_];
         }
         for(_loc1_ in this.var_916)
         {
            delete this.var_916[_loc1_];
         }
         if(this.var_35 != null)
         {
            this.var_35.dispose();
      ...
      {
         var _loc2_:Class = this.var_916[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_496[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_947,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_913,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1018,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_962,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_496[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_496[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_149[struct.assetName] == null)
                  {
                     ++this.var_404;
                     this.var_405.push(struct.assetName);
                  }
                  this.var_149[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_42,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_496[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_149[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_405.length ? this.getAssetByName(this.var_405[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_149)
         {
            if(this.var_149[_loc2_] == param1)
            {
               return this.var_405.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_149[param1] != null || (this.var_610 != null ? this.var_610[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_149[param1] == null;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_149)
            {
               if(this.var_149[_loc2_] == param1)
               {
                  this.var_405.splice(this.var_405.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_286.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_286[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_406.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_406[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_286[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_406[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_286)
            {
               _loc3_ = AssetTypeDeclaration(var_286[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_406)
         {
            _loc3_ = AssetTypeDeclaration(this.var_406[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_286)
            {
               _loc4_ = AssetTypeDeclaration(var_286[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_406)
         {
            _loc4_ = AssetTypeDeclaration(this.var_406[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_748 = _loc2_.manifest.copy();
         ...
         this.var_917 = true;
         dispatchEvent(new Event(AssetLibrary.const_749));
         dispatchEvent(new Event(AssetLibrary.const_1082));
         if(this.var_914)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1460));
         this.var_35 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_748.child("library");
         if(_loc2_ == null)
         {
