package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1411:int = 10000;
      ...
      private var var_429:ByteArray;
      
      private var var_965:IEncryption;
      
      private var var_638:IProtocol;
      ...
      private var var_430:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_289 = param2;
         this.var_429 = new ByteArray();
         this.var_966 = new MessageClassManager();
         this.var_72 = new Socket();
         this.var_296 = new Timer(const_1411,1);
         this.var_296.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_430)
         {
            this.var_430.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_296.start();
         this.var_637 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_638.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_430)
         {
            this.var_430.messageSent(String(_loc4_),_loc5_.toString());
         }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_638.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_638.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_638.getMessages(this.var_429,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_430)
               {
                  this.var_430.messageReceived(String(id),data.toString());
               }
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_429,offset);
               this.var_429 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_429.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_429.writeByte(this.var_72.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_296.stop();
         this.var_1456 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_637));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1456 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_637));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_637));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_637));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_637));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_637));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_296.delay + " ms). Possible Firewall.";
