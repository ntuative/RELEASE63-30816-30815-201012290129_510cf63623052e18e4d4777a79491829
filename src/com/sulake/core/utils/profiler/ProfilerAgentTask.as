package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerAgentTask implements IDisposable
   {
      ...
      public function stop() : void
      {
         if(this.var_661)
         {
            this.var_1752 = getTimer() - this.var_2407;
            ++this.var_1117;
            this.var_1371 += this.var_1752;
            this.var_1751 = this.var_1371 / this.var_1117;
            this.var_661 = false;
         }
      }
