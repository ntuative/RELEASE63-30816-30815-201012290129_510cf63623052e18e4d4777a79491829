package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected var var_943:Boolean = false;
      ...
      protected var var_1895:int;
      
      protected var var_1175:int;
      
      protected var var_1176:int;
      
      protected var var_2725:uint = 0;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_957)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_662[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_662.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_662.length < const_1374 && false)
            {
      ...
      {
         return !!this.var_943 ? uint(this.var_1175 - this.var_1895) : uint(getTimer() - this.var_1895);
      }
      ...
      {
         if(!this.var_943 && !_disposed && this.var_1176 > 0)
         {
            try
            {
               this.var_35.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_214,const_1457 - this.var_1176);
            if(this.var_2645)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_413 == LibraryLoader.const_1526)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         try
         {
            this.var_748 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
