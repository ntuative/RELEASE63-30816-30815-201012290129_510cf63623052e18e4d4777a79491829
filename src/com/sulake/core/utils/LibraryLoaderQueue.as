package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1374:int = 4;
      ...
      {
         return this.var_382.length + this.var_258.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_258.length < const_1374 && this.var_382.length > 0)
            {
               _loc1_ = this.var_382.shift();
               this.var_258.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            ...
            index = this.var_258.indexOf(loader);
            if(index > -1)
            {
               this.var_258.splice(index,1);
            }
         }
         catch(e:Error)
         {
