package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1090:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1090.volume);
      }
      ...
      {
         if(param1.type != WindowEvent.const_380)
         {
            return;
         }
         this.var_1090.saveVolume(this.getValue(param2.x),false);
      }
