package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_903:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_454 = param1.volume;
         if(this.var_903 != null)
         {
            this.var_903.setValue(this.var_454);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1788 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1787 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1786 = (_loc5_.content as BitmapData).clone();
         }
         this.var_903 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_761));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_454 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1788);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1785);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_454 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1787);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1786);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_627);
         }
