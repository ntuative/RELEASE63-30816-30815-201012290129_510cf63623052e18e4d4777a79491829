package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1005:TagListRenderer;
      
      private var var_123:IBorderWindow;
      
      private var var_2227:int;
      
      private const const_851:int = 5;
      
      private const const_1559:int = 39;
      
      private const const_1558:int = 7829367;
      
      private const const_1560:int = 16777215;
      
      private const const_1833:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1005 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_48 == null || this.var_194 == null || this.var_62 == null)
         {
            return;
         }
         this.var_62.width = this.var_62.scrollableRegion.width;
         this.var_48.height = this.var_48.scrollableRegion.height;
         this.var_194.height = this.var_48.height + 20;
         this._window.width = Math.max(this.var_194.width,this.var_62.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_194.width < this.var_62.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         {
            this.var_48 = this.var_194.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc6_:IBitmapWrapperWindow = this.var_194.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_194.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_194.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_194.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_851;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1558;
            }
            else
            {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_851;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1005.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_174);
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_174:
               this.var_62.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_247:
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_891:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_982:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2227 > this.const_1833 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2227 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1558;
            if(_loc3_.length >= this.const_1559)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1559 - 1);
            }
         }
      }
