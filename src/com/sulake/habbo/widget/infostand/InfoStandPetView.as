package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1826:int = 158;
      
      private const const_1828:int = 16;
      
      private const const_1829:uint = 11184810;
      
      private const const_1832:uint = 6710886;
      
      private const const_1830:uint = 3355443;
      
      private const const_1831:String = "level";
      
      private const const_1827:String = "experience";
      
      private const const_1825:String = "energy";
      
      private const const_1824:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1831,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1827,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1825,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1824,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_600 = param1.id;
         this.var_1263.remove(param1.id);
         this.var_1263.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1826,this.const_1828,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1829);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1830);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1832);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1263.getValue(this.var_600) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_175 && this.var_175.getPetId() == this.var_600)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_473,this._widget.petData.ownerId);
