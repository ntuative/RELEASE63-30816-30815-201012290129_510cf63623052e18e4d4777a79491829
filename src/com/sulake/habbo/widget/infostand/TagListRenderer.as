package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1819:int = 5;
      
      private const const_1820:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_137:Function;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_990 + param1.height > this.var_989.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_990 += param1.height + this.const_1820;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_990);
         this._offsetX += param1.width + this.const_1819;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1234 != null && this.var_1234.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_137);
