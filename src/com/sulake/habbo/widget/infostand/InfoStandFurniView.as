package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_883 = this.var_194.findChildByTag("catalog");
         if(this.var_883 != null)
         {
            this.var_883.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_48.addListItem(this.var_883);
            }
            this.var_883.visible = param1;
         }
         else
         {
            this.var_48.removeListItem(this.var_883);
         }
      }
   }
}
