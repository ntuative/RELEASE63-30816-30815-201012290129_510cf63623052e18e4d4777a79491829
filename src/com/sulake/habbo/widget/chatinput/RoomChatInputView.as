package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1234:int = 40;
      
      private static const const_1584:int = 5;
      
      private static const const_1235:int = 20;
      ...
      private var var_440:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1127 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2465 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2467 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_334 = new Timer(1000,1);
         this.var_334.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_334.reset();
            this.var_334.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         }
         this.var_334 = null;
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_380,this.onWindowMoved);
         this.var_1767 = true;
         this.var_487 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2466 = _loc2_.width + const_874 + _loc6_.width + const_1235;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1234,_loc8_.width) + const_874);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_440 = param1 - this.var_2466;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_440);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_440);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1127 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_487 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_487.length + 1)
            {
               _loc2_.text = "";
            }
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_440)
         {
