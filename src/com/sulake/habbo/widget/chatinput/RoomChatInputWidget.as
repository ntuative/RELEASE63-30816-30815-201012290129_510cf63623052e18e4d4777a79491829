package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private var var_752:Timer = null;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_568,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_219,this.onRoomObjectDeselected);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_273,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_778,this.onChatInputUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_219,this.onRoomObjectDeselected);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_273,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_778,this.onChatInputUpdate);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_961:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1356:
         }
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         this.var_2394 = param1.allowPaste;
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this.var_753 = this.var_753 - 1;
            this._visualization.showFloodBlocking(this.var_753);
         }
      }
      ...
      {
         this.var_1421 = true;
         this.var_753 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_753 + " seconds");
         if(this.var_752)
         {
            this.var_752.reset();
         }
         ...
         {
            this.var_752 = new Timer(1000,this.var_753);
            this.var_752.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_752.addEventListener(TimerEvent.TIMER_COMPLETE,this.method_7);
         }
         this.var_752.start();
         if(this._visualization != null)
         {
