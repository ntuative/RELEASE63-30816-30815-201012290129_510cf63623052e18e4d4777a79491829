package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1567:int = 0;
      
      private const const_1568:int = 1;
      
      private const const_1570:int = 2;
      ...
      private const const_1850:String = "xmas10_dialog_bg_png";
      
      private const const_1845:String = "xmas10_dialog_telepair_png";
      
      private const const_392:String = "xmas10_present_dialog_img_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_428,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_428,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_428:
         ...
         if(this.var_1348 != _loc2_ && this._window)
         {
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            ...
            if(_loc6_)
            {
               _loc5_ = (assets.getAssetByName(this.const_1850) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_671);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1347,_loc4_);
         this.hideInterface();
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_626,"ViralGift",param1,param2,param3);
