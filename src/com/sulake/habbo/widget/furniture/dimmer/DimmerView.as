package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1171,const_1172,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_377 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1283 = _loc2_.light;
         if(this.var_377 != null)
         {
            this.var_377.setValue(this.var_1283);
         }
         this.var_453 = this.colors.indexOf(_loc2_.color);
         if(this.var_556 != null)
         {
            this.var_556.setSelectedColorIndex(this.var_453);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1284 = XML(_loc1_.content);
         return this.var_1284;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_377 != null)
         {
            this.var_377.min = this._widget.minLights[param1 - 1];
         }
      }
