package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1537) as IWindowContainer;
            ...
            _loc3_.width = this.var_543.width;
            _loc3_.height = this.var_543.height;
            this.var_448.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_543.width,this.var_543.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_543,this.var_543.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1011.width,this.var_1011.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_817.width,this.var_817.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_817,this.var_817.rect,new Point(0,0),null,null,true);
