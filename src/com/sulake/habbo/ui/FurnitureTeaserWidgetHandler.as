package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_776,RoomWidgetViralFurniMessage.const_671,RoomWidgetViralFurniMessage.const_152];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_776:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_428);
                     _loc7_.data = _loc6_;
                     this._container.events.dispatchEvent(_loc7_);
                  }
               }
               break;
            case RoomWidgetViralFurniMessage.const_671:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_406,RoomSessionViralFurniStatusEvent.const_462];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_406:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_569);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_462:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
