package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1017:IRoomWidgetFactory = null;
      
      private var var_387:ISessionDataManager = null;
      
      private var var_17:IRoomSessionManager = null;
      
      private var var_468:IAvatarRenderManager = null;
      ...
      private var var_1016:IHabboHelp = null;
      ...
      private var var_192:IToolTipWindow;
      
      private var var_2179:uint = 16777215;
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_265,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_348,this.onRoomContentLoaded);
      ...
      public function dispose() : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_265,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_348,this.onRoomContentLoaded);
      ...
      public function init() : void
      {
         ...
         if(this.var_266 != null && this.var_29.state == RoomSessionEvent.const_227)
         {
            this.var_1572 = !this.var_266.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1017.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_681.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_681.add(_loc9_,_loc6_);
                  }
                  else
                  {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_681.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_643:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_317,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(this.var_820 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_29.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_342)
                  {
                     this.var_820.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_527:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_963,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_693);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_576);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_608);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_575);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_299,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2179);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_192 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_192.width / 2,15);
            this.var_192.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1574) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","BadgeImageReadyEvent",_loc3_);
               }
               else
               {
      ...
      {
         if(this.var_17 != null && this.var_29 != null && this.var_1572 && this.var_1573)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_368);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_438:
               ...
               this.var_192 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_336,WindowStyle.const_744,WindowParam.const_92) as IToolTipWindow;
               this.var_192.setParamFlag(WindowParam.const_28,false);
