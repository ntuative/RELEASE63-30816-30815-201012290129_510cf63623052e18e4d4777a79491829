   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_740,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_407,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_740,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_949,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1063,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_407,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1360)
            {
               ...
               this.var_1730 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1730;
            }
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_738);
         _loc1_.push(RoomWidgetDanceMessage.const_745);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_810);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_565);
         _loc1_.push(RoomWidgetStopEffectMessage.const_700);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1432);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_989);
         _loc1_.push(RoomWidgetToolbarMessage.const_625);
         _loc1_.push(RoomWidgetToolbarMessage.const_616);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_358);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1463);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1035);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_647);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_622);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_761);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1446);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_764);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_627);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_809);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_314);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_622:
               ...
               break;
            case RoomWidgetWaveMessage.const_738:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_745:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_687:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_565:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1073)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_186,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_810:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_927:
                        this._catalog.openCatalogPage(CatalogPageName.const_1413,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_932:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_295);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1326:
            ...
            case RoomWidgetStopEffectMessage.const_700:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1114:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1429:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_989:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_647:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_625:
            ...
            case RoomWidgetToolbarMessage.const_616:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_416,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_358:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_413));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_761:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_320,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_764:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_320,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_627:
            ...
            case RoomWidgetAvatarEditorMessage.const_809:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_439));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_314:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_656));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_407:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_511));
         }
      }
