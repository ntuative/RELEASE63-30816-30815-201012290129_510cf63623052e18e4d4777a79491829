package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1017:IRoomWidgetFactory;
      ...
      private var var_1016:IHabboHelp;
      
      private var var_820:IHabboModeration;
      ...
      private var var_1018:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1252 = RoomDesktop.const_453;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1017.release(new IIDHabboRoomWidget());
            this.var_1017 = null;
         }
         ...
         {
            this.var_468.release(new IIDAvatarRenderManager());
            this.var_468 = null;
         }
         ...
         {
            this.var_1016.release(new IIDHabboHelp());
            this.var_1016 = null;
         }
         ...
         {
            this.var_820.release(new IIDHabboModeration());
            this.var_820 = null;
         }
         ...
         if(this.var_1018)
         {
            this.var_1018.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1018 = null;
         }
         this.var_1542 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1017 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_468 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_266.events.addEventListener(AdEvent.const_474,this.adEventHandler);
            this.var_266.events.addEventListener(AdEvent.const_491,this.adEventHandler);
            this.var_266.events.addEventListener(AdEvent.const_460,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1016 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_820 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_820);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_17)
         {
            this.var_17.events.addEventListener(RoomSessionEvent.const_227,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionEvent.const_84,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionChatEvent.const_189,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionChatEvent.const_471,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionUserBadgesEvent.const_126,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDoorbellEvent.const_105,this.roomSessionEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionPresentEvent.const_271,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionViralFurniStatusEvent.const_406,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionViralFurniStatusEvent.const_462,this.roomSessionEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_785,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_1013,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_974,this.roomSessionDialogEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_200,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_215,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_208,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_233,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_231,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_655,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_711,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_162,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_742,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_686,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionQueueEvent.const_492,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionVoteEvent.const_116,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionVoteEvent.const_121,this.roomSessionEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionPollEvent.const_132,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDimmerPresetsEvent.const_430,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionFriendRequestEvent.const_129,this.roomSessionEventHandler);
         }
      }
      ...
      {
         this.var_1018 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_747,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_572,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_784,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_818,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_276,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_741,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_216,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_747)
         {
            if(this.var_17 != null)
            {
               this.var_17.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_527 || param1.type == RoomEngineEvent.const_506)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_572:
               ...
               if(this.var_1252 != RoomDesktop.const_453)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_286,this.var_1252);
               }
               if(this.var_266 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_784:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_818:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.habboHelp = this.var_1016;
         _loc3_.moderation = this.var_820;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_574;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1018;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_453)
            {
               this.var_1252 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
