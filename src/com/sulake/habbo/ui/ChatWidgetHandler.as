   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_361 != null)
         {
            ...
            {
               _loc2_ = this.var_361.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_568,RoomWidgetChatSelectAvatarMessage.const_604];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_568:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_250)
                           {
                              _loc13_ = this.var_360.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_361.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_801.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_250:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_86,this);
                                       if(_loc17_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_86,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 {
                                    this.var_361.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_801.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_983 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_983);
            }
            if(this.var_655 == null)
            {
               ...
               this.var_438.y = 0;
               this.var_438.z = 0;
               this.var_655 = _loc4_.getScreenPoint(this.var_438);
               this.var_983 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_438.x = 0;
