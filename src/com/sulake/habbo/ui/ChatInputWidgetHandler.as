package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetChatTypingMessage.const_690);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_798:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_690:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_900,HabboToolbarIconEnum.CHATINPUT,param1));
      ...
      {
         return [RoomSessionChatEvent.const_471];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_471:
