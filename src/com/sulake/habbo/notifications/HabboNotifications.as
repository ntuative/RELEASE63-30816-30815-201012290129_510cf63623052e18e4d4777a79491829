package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1206:String = "pixelbalance";
      
      private static const const_1203:String = "badges";
      
      private static const const_1201:String = "selectbadge";
      
      private static const const_1202:String = "inventory";
      
      private static const const_1200:String = "selectfurni";
      
      private static const const_1204:String = "credits";
      
      private static const const_1207:String = "friendlist";
      
      private static const const_1205:String = "pet_inventory";
      ...
      private var var_708:IHabboToolbar;
      ...
      private var var_472:HabboNotificationViewManager;
      
      private var var_200:HabboAlertDialogManager;
      
      private var var_707:ParkBusDialogManager;
      
      private var var_2314:Boolean;
      
      private var var_874:ClubGiftNotification;
      
      private var var_873:ClubEndingNotification;
      
      private var var_871:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_872);
         }
         var _loc6_:Map = this.var_872["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_708)
         {
            this.var_708.release(new IIDHabboToolbar());
            this.var_708 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_872["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1068.push(_loc8_);
         return this.var_1068.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1068.splice(0,1);
      ...
      {
         this.var_708 = IHabboToolbar(param2);
         this.var_708.events.addEventListener(HabboToolbarEvent.const_67,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_67)
         {
            ...
            this.var_472 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_872["styles"],this.var_872["view"],this.var_708);
            ...
            registerUpdateReceiver(this.var_472,1);
            registerUpdateReceiver(this,2);
            this.var_387.events.addEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImage);
            this.var_708.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1324[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_387);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1285);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_387.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_924);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_924);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1485);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_468.createAvatarImage(param2,AvatarScaleType.const_49);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_387.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_76)
               {
                  _loc9_ = this.var_387.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_387.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1402,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1371);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1486)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_873 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_871 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1683 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_472.isSpaceAvailable() && this.var_1068.length > 0)
         {
            this.var_472.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1203:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_295);
               }
               break;
            case const_1201:
               break;
      ...
      {
         if(param1 != null && this.var_472 != null)
         {
            this.var_472.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_707 == null)
         {
            this.var_707 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_707 != null)
         {
            this.var_707.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_468.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_468.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2314)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1029);
            this.var_2314 = true;
      ...
      {
         if(param2.type == WindowEvent.const_182 || param2.type == WindowEvent.const_623)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_874 && this.var_874.visible)
         {
            return;
         }
         this.var_874 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1029,_loc6_);
      }
   }
}
