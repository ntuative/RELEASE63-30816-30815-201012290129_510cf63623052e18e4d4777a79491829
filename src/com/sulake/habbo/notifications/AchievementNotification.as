package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1587:String = "badge_bg_001_png";
      
      private const const_1859:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2593 = this._localizations.getBadgeName(this.var_288);
         this.var_2591 = this._localizations.getBadgeDesc(this.var_288);
         this.var_2592 = this._localizations.getAchievementNameForFacebook(this.var_288,this.var_387.userName,this.var_387.realName,this.var_1413);
         this.var_2589 = this._localizations.getAchievementDescForFacebook(this.var_288,this.var_387.userName,this.var_387.realName,this.var_1413);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2590 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1798.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1414.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1414.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1840;
         var _loc17_:String = this.var_1840 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_1999);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1587);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1859) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2593);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2591);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2592);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2589);
         this._localizations.registerParameter(param1,"level",this.var_1413.toString());
         this._localizations.registerParameter(param1,"name",this.var_387.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_387.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_387.events.removeEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImageReady);
            this.var_387 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1587);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_288,this._feedTitleFb,this.var_2590,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2594));
