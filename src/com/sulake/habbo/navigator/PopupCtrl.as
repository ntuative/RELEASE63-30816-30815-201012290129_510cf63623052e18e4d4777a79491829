package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_50 == null)
         {
            this.var_50 = IWindowContainer(this._navigator.getXmlWindow(this.var_1258));
            this.var_50.visible = false;
            this.var_50.setParamFlag(HabboWindowParam.const_36,true);
         ...
         this.var_50.x = _loc2_.x + this.var_2032 + param1.width;
