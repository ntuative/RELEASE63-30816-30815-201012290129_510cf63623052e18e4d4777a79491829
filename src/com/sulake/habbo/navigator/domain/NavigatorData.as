package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private var var_592:RoomEventData;
      ...
      private var var_894:PublicRoomShortData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_894 = param1.publicSpace;
            this.var_592 = null;
         }
      }
      ...
      {
         return this.var_1374 >= this.var_2457;
      }
