package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1209:CutToWidth = new CutToWidth();
      
      private static var var_1210:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1209.beforeSearch(param2,param1,param3);
         binarySearch(var_1209,param2.length - 1);
      }
      
      public static function method_10(param1:ITextWindow, param2:String, param3:int) : void
      {
         param1.text = param2;
         ...
         var_1210.beforeSearch(param2,param1,param3);
         binarySearch(var_1210,param2.length - 1);
      }
