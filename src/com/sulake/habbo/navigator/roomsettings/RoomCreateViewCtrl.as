package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
         ...
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_53,540,"t"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_53,512,"w"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_53,396,"x"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_53,440,"y"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_53,456,"z"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_53,208,"0"));
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1776 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1776 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1134 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_168.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_31,HabboWindowParam.const_57,new Rectangle(0,0,100,300)));
      }
