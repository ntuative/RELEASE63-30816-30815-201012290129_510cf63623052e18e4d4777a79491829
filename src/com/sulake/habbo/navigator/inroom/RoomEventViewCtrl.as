package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_877:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2320.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_709.setText(param1.eventDescription);
      ...
      {
         var _loc1_:int = this.var_877.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_709.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_709.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1692 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2320 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1690 = ITextWindow(this.find("create_caption"));
            this.var_1691 = ITextWindow(this.find("edit_caption"));
            this.var_1330 = IButtonWindow(this.find("create_button"));
            this.var_1329 = IButtonWindow(this.find("edit_button"));
            this.var_2321 = IButtonWindow(this.find("cancel_button"));
            this.var_1328 = IButtonWindow(this.find("end_button"));
            this.var_877 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1330,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1329,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1328,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2321,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_709 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
