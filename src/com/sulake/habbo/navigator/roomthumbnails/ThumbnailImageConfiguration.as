package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1604 = this._navigator.getButtonImage(this.var_1605);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1603 == null)
         {
            ...
            this.var_1603 = new Rectangle(this.var_1287,this.var_1287,_loc1_.width - 2 * this.var_1287,_loc1_.height - 2 * this.var_1287);
         }
         this.var_558.bitmap.fillRect(this.var_558.bitmap.rect,4281545523);
         this.var_558.bitmap.fillRect(this.var_1603,4284900966);
         this.copyTo(this.var_558.bitmap);
         if(this.var_176)
         {
            this.var_558.bitmap.copyPixels(this.var_1602,this.var_1602.rect,new Point(0,0),null,null,true);
         }
