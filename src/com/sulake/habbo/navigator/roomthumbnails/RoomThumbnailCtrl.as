package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1708 = IButtonWindow(this.find("bg_tab"));
         this.var_1707 = IButtonWindow(this.find("top_tab"));
         this.var_1709 = IButtonWindow(this.find("obj_tab"));
         this.var_2365 = IWindowContainer(this.find("tile_grid"));
         ...
         Util.setProcDirectly(this.var_1708,this.onBgTabButton);
         Util.setProcDirectly(this.var_1707,this.onTopTabButton);
         Util.setProcDirectly(this.var_1709,this.onObjTabButton);
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_63.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      ...
      private function onImgSel(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_63.method_8(param2.id);
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1708,this.var_63.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1707,this.var_63.mode != ThumbnailEditorModel.const_56);
         this.setEnabled(this.var_1709,this.var_63.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_obj",this.var_63.mode == ThumbnailEditorModel.const_34,false);
         if(this.var_63.mode == ThumbnailEditorModel.const_34)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_483)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_31,HabboWindowParam.const_57,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_307,HabboWindowStyle.const_37,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
