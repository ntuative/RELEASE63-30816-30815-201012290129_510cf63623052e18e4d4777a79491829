package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_366:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2721:Dictionary;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1104 = new RoomCreateViewCtrl(this);
         this.var_2246 = new RoomThumbnailRenderer(this);
         this.var_843 = new GuestRoomPasswordInput(this);
         this.var_327 = new GuestRoomDoorbell(this);
         this.var_366 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_307,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_586.registerToolbarEvents();
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_279.startSearch(Tabs.const_248,Tabs.const_326,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_279.startSearch(Tabs.const_262,Tabs.const_239);
         this.var_366.getTab(Tabs.const_262).tabPageDecorator.tabSelected();
      }
