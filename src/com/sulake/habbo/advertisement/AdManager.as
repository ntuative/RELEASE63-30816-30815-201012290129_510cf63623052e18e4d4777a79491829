package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2084 = this._config.getKey("interstitial.enabled","false") == "true";
         ...
         this.var_1525 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_189 != null && this.var_189.running)
         {
            this.var_189.reset();
            return false;
         }
         ...
         if(this.var_1525 > 0 && this.var_1523 >= this.var_1525)
         {
            return false;
         }
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1239 != "")
         {
            ...
            {
               this.var_189 = new Timer(this.var_2086,1);
               this.var_189.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_189.running)
            {
               this.var_189.reset();
            }
            this.var_189.start();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_491,0,0,param1.bitmapData,this.var_2083));
            this.var_999 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_474));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1238 = _loc2_.imageUrl;
         this.var_1524 = _loc2_.clickUrl;
         if(this.var_1238 != "" && this.var_1524 != "")
         {
            _loc3_ = this.var_1238;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1238);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_460,0,0,_loc4_,this.var_1524,this.var_1001,this.var_1000));
         }
      }
