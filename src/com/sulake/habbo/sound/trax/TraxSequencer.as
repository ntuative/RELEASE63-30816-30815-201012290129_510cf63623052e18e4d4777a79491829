package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private var var_1398:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1800:TraxData;
      ...
      {
         this.var_1802 = uint(const_258 / 44.1);
         super();
         this._events = param4;
         this.var_2171 = param1;
         this.var_454 = 1;
         this.var_1398 = new Sound();
      ...
      public function play() : Boolean
      {
         ...
         this.var_1397 = false;
         this.var_1398.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1398.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1398.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1800.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1800.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1801.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         this.var_206 += const_258;
         if(this._soundChannel != null)
         {
            this.var_1802 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_206 > this._length + this.var_1802 * 44.1)
         {
            this.var_1397 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_677,this.var_2171));
      }
   }
}
