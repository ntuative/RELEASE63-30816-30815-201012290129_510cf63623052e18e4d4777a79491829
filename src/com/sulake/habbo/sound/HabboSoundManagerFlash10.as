package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_834:TraxSequencer;
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_552.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_678.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_678,events);
         _loc8_.volume = this.var_454;
         this.var_834 = null;
         this.var_677 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_832.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_832 = IHabboNotifications(param2);
      }
      ...
      {
         if(this._configuration == null || this._connection == null || this._roomEngine == null || this.var_551 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_552.getValue(_loc2_);
         ...
         this.var_552.remove(_loc2_);
         this.var_678.add(_loc3_,_loc6_);
         if(this.var_552.length == 0 && this.var_677 != -1)
         {
            this.var_834.ready = true;
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1279,this.var_677));
         this.var_677 = -1;
         this.var_834 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_454 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_454 * 100)));
         }
      }
      ...
      {
         this.var_454 = param1;
         this.var_551.updateVolume(this.var_454);
