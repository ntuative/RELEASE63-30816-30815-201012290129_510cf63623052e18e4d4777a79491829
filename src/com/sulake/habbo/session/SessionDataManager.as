package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_608:ProductDataParser;
      ...
      private var var_284:FurnitureDataParser;
      
      private var var_1808:UserTagManager;
      
      private var var_1399:BadgeImageManager;
      
      private var var_1146:HabboGroupInfoManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_905 = [];
         this.var_1808 = new UserTagManager(events);
         this.var_1146 = new HabboGroupInfoManager(this,events);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_284)
         {
            this.var_284.removeEventListener(FurnitureDataParser.const_111,this.onFurnitureReady);
            this.var_284.dispose();
            this.var_284 = null;
         }
         if(this.var_608)
         {
            this.var_608.removeEventListener(ProductDataParser.const_111,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1399 = new BadgeImageManager(context.root.assets,events,this._configuration,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1808.communication = this._communication;
         this.var_1146.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_284)
         {
            ...
            this.var_284 = new FurnitureDataParser(this.var_491,this._wallItems,this.var_490,this._localization);
            this.var_284.addEventListener(FurnitureDataParser.const_111,this.onFurnitureReady);
            if(this._configuration.keyExists("furnidata.load.url"))
            {
               _loc3_ = this._configuration.getKey("furnidata.load.url");
               this.var_284.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_284)
         {
            this.var_284.localization = this._localization;
            this.var_284.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2054 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_742 = _loc3_.petRespectLeft;
         this.var_561 = _loc3_.figure;
         this.var_849 = _loc3_.sex;
         this.var_1510 = _loc3_.realName;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_561 = _loc2_.figure;
            this.var_849 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_561,this.var_849));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2548 = _loc2_.isOpen;
         this.var_2549 = _loc2_.onShutDown;
      }
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return this.var_905.indexOf(param1) >= 0;
      }
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return this.var_905.indexOf("fuse_any_room_controller") >= 0;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1808.getTags(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         var _loc2_:HabboGroupDetails = this.var_1146.getGroupDetails(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1146.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1146.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1399.getBadgeImage(param1,BadgeImageManager.const_926);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_742 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_742 = this.var_742 - 1;
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_1145.indexOf(param1) == -1)
         {
         ...
         if(this.var_608 == null)
         {
            ...
            this.var_608 = new ProductDataParser(_loc2_,this.var_1128);
            this.var_608.addEventListener(ProductDataParser.const_111,this.onProductsReady);
         }
         return false;
      }
