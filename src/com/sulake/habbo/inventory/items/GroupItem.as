package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_770:int = 0;
      
      protected var var_626:BitmapData;
      ...
      protected var var_2653:BitmapData;
      
      private const const_1837:int = 8947848;
      
      private const const_1836:int = 13421772;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1906 = param8;
         this.var_1268 = param9;
         if(param10 != null)
         {
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1268));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1906);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_770 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_648)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function method_1() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_1905 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2653;
               _loc5_.visible = true;
            }
            else
            {
