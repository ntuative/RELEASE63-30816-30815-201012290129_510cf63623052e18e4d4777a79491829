package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_873:uint = 4284532064;
      
      private static const const_872:uint = 2577770;
      ...
      private var var_395:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_395 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_184)
            {
               this.var_184.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_184.stop();
               this.var_184 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1753 = this.createMinimizedWindow();
         }
         if(!this.var_2444)
         {
            return this.var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_873) : uint(const_872);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_873) : uint(const_872);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_184 = new Timer(1000,3);
            this.var_184.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_184.reset();
         this.var_184.repeatCount = 3;
         this.var_184.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_184.currentCount));
         if(this.var_184.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_146)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1009)
            {
            ...
            this.var_395.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_526);
            this.var_395.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_395.hideDelayed();
         }
      }
