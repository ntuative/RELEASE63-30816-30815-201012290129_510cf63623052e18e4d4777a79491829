package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1274:uint = 9;
      ...
      public static const const_520:uint = 4;
      
      public static const const_235:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_49.updateItemList(this.var_703);
         this.var_49.updateItemList(this.var_1315);
      ...
      public function close() : void
      {
         if(this.var_661)
         {
            if(this._state != const_175 && this._state != const_235)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_175;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1096);
            this.var_661 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_702 + " OTHER: " + this.var_1063);
         ...
         {
            case const_175:
               if(param1 == const_178 || param1 == const_235)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_49.alertPopup(TradingView.const_941);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_703)
            {
               this.var_702 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1063 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_703)
            {
               this.var_49.alertPopup(TradingView.const_917);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_274.length < const_1274)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_146)
            {
