package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1002:IRoomSession;
      ...
      private const const_1835:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_519,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_290));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_611));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_295));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_313));
      }
      ...
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_145));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_347) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_519,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_387 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_347,_loc1_);
         ...
         this.var_46.add(InventoryCategory.const_295,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_611,_loc4_);
         ...
         this.var_46.add(InventoryCategory.const_313,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_290,_loc6_);
         ...
         this.var_46.add(InventoryCategory.const_145,_loc8_);
         this.var_173 = true;
         if(this.var_2264)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_290:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_862.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_862.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_862.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1835);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_949));
      }
