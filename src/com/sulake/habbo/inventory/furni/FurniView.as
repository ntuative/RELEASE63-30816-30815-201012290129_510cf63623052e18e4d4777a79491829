package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1867:int = 0;
      
      private const const_869:int = 1;
      
      private const const_1578:int = 2;
      
      private const const_1575:int = 3;
      
      private const const_1577:int = 42;
      
      private const const_1576:int = 120;
      ...
      private var var_713:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_477.add(FurniModel.const_41,new FurniGridView(this.var_63,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_477.add(FurniModel.const_44,new FurniGridView(this.var_63,FurniModel.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FurniModel.const_41:
               ...
               this.var_391 = FurniModel.const_41;
               break;
            case FurniModel.const_378:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_391 = FurniModel.const_378;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_477.getValue(this.var_391);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_63.getCategoryContent(this.var_391);
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_477.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_477.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_477.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_63.getGroupItemInIndex(_loc3_,this.var_391);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            {
               if(_loc5_.category == FurniCategory.const_146)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_713 && this.var_713.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1576)
         {
            _loc3_ = this.const_1576;
         }
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_378);
            }
         }
      }
   }
