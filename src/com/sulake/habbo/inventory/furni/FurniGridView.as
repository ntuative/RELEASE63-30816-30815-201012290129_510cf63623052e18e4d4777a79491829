   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_38)
         {
            ...
            this.var_63.toggleItemSelection(this._category,this.var_445.getGridItemIndex(param1.window));
            this.var_536 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_536 != null && this.var_536 == param2 && !this.var_63.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_299)
         {
