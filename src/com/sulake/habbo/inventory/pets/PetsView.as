package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      {
         var _loc2_:PetsGridItem = this.var_605.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function selectFirst() : void
      {
         ...
         this.setSelectedGridItem(this.var_605.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_605.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_605.add(param1.id,_loc2_);
         ...
         if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_63.switchCategory(FurniModel.const_44);
            }
            this.selectPetsTab();
         }
      }
