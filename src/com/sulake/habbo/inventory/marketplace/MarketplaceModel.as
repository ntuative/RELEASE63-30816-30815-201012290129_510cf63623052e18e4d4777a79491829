package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_203 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_203.id);
            this.var_203 = null;
         }
      }
      ...
      {
         if(this.var_203 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_203 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_203.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_203 is FloorItem ? 1 : 2;
         this.var_2241 = _loc2_;
         this.var_2239 = this.var_203.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_203.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_203);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1696,this.var_1697);
         }
      }
      ...
      {
         if(param1 != this.var_2241 || param2 != this.var_2239)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2243);
      }
