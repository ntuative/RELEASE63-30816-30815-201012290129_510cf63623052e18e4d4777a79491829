package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1451:TriggerConfs;
      
      private var var_1449:ActionTypes;
      
      private var var_1450:ConditionTypes;
      
      private var var_222:Dictionary;
      
      private var var_57:Triggerable;
      
      private var var_636:RoomObjectHightLighter;
      
      private var var_156:UserDefinedRoomEventsHelp;
      
      private var var_960:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1451 = new TriggerConfs();
         this.var_1449 = new ActionTypes();
         this.var_1450 = new ConditionTypes();
         this.var_222 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_636 = new RoomObjectHightLighter(param1);
         this.var_156 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_222[param1];
            this.var_636.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_57.furniLimit)
         {
            this.var_222[param1] = param2;
            this.var_636.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_960 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_960.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_960.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_636.hideAll(this.var_222);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_960.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_156.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1451);
         this.refreshConfigureElement(this.var_1449);
         this.refreshConfigureElement(this.var_1450);
