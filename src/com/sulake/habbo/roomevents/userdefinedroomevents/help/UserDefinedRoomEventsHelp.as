package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1092:IContainerButtonWindow;
      
      private var var_1091:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1711 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1091 = this.var_1711.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1091)
         {
            this.var_1091.procedure = this.onButtonClick;
         }
         this.var_1092 = this.var_1711.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1092)
         {
            this.var_1092.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_244 >= this._localizations.length - 1)
         {
            this.var_1092.disable();
         }
         else
         {
            this.var_1092.enable();
         }
         if(this.var_244 <= 0)
         {
            this.var_1091.disable();
         }
         else
         {
            this.var_1091.enable();
         }
      }
      ...
      {
         ++this.var_244;
         this.var_244 = Math.min(this.var_244,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_244;
         this.var_244 = Math.max(this.var_244,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_244][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_244][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_244][1]).value;
