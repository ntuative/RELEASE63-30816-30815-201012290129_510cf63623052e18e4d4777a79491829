package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1546 ? 0 : 1,this._roomId),this.var_45,WindowTracker.const_598,this._roomId),this._frame,false,false,true);
      }
