package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1447;
      ...
      {
         return WindowTracker.const_1336;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_45.initMsg.messageTemplates[this.var_1012.selection];
         if(_loc3_ != null)
         {
            this.var_596 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.connection.send(new ModMessageMessageComposer(this.var_1206,this.var_424.text,this.var_1205));
         this.dispose();
      }
