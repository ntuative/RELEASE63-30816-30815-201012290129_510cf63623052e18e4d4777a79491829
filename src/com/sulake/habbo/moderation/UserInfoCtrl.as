package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_846:int = 60;
      
      private static const const_843:int = 3600;
      
      private static const const_845:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_846) + " mins ago";
         }
         if(param1 < 2 * const_845)
         {
            return Math.round(param1 / const_843) + " hours ago";
         }
         if(param1 < 2 * const_844)
         {
            return Math.round(param1 / const_845) + " days ago";
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_45,WindowTracker.const_1047,this._data.userId),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new RoomVisitsCtrl(this.var_45,this._data.userId),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new SendMsgsCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1205),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ModActionCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1205),this._callerFrame,this.var_1019,false,true);
      }
