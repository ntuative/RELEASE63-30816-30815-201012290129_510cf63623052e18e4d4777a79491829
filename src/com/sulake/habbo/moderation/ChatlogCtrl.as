package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1745:IMessageComposer;
      ...
      {
         this.var_1108 = IWindowContainer(this.var_45.getXmlWindow("chatlog_roomheader"));
         this.var_1107 = IWindowContainer(this.var_45.getXmlWindow("chatlog_chatline"));
         this.var_394 = new Timer(1000,1);
         ...
         this.var_45.connection.send(this.var_1745);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_1108.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_1107.clone());
         _loc4_.color = this.var_1744[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1366.getValue(param2.chatterName))
            {
               this.var_1366.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1366.getValue(_loc2_);
         this.var_45.windowTracker.show(new UserInfoFrameCtrl(this.var_45,_loc3_),this._frame,false,false,true);
      }
