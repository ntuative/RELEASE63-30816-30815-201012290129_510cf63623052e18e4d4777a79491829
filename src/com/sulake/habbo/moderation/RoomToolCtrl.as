package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this.var_45.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_315));
      ...
      public function populate() : void
      {
         ...
         this.var_1247 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1246 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_45,WindowTracker.const_598,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_45.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1440,_loc2_,this.var_424.text,"",""));
         if(this.var_1247.isSelected || this.var_1246.isSelected || this.var_818.isSelected)
         {
            this.var_45.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1247.isSelected,this.var_1246.isSelected,this.var_818.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1412);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_45.initMsg.roomMessageTemplates[this.var_1012.selection];
         if(_loc3_ != null)
         {
            this.var_596 = false;
            this.var_424.text = _loc3_;
         }
      }
   }
}
