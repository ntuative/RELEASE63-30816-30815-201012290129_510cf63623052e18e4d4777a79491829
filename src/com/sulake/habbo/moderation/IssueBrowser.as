package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1840:String = "my_issues";
      
      private const const_1841:String = "open_issues";
      
      private const const_1839:String = "picked_issues";
      
      private const const_1866:String = "closed_issues";
      ...
      private var var_1701:IIssueBrowserView;
      
      private var var_1700:IIssueBrowserView;
      
      private var var_1702:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_326.view.width = this.var_243.container.width;
         this.var_326.view.height = this.var_243.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1840:
               ...
               {
                  this.var_1701 = new MyIssuesView(this.issueManager,this,this.var_243.container);
               }
               return this.var_1701;
            case this.const_1841:
               if(this.var_1700 == null)
               {
                  this.var_1700 = new OpenIssuesView(this.issueManager,this,this.var_243.container);
               }
               return this.var_1700;
            case this.const_1839:
               if(this.var_1702 == null)
               {
                  this.var_1702 = new PickedIssuesView(this.issueManager,this,this.var_243.container);
               }
