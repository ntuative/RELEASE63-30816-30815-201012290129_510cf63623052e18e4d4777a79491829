package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2559:PseudoRandom;
      ...
      private const const_1541:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_609 = param1;
            this.var_47.initConnection(HabboConnectionType.const_206);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_88,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_47 && this._habboConfiguration && this.var_17 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_609 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1820 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2558 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_209 == null)
         {
            this.var_209 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_47.mode = HabboConnectionType.const_108;
            if(this.var_609)
            {
               this.var_47.initConnection(HabboConnectionType.const_206);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_502,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_47.mode = HabboConnectionType.const_1020;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_206);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_816);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2559 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_108:
               ...
               this.var_209.loadBannerImage(_loc7_ + "?token=" + this.var_1405,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1020:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1303:
               this.var_910 = this.generateRandomHexString(30);
               this.var_494 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_494.init(this.var_910);
               _loc8_ = this.var_494.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_494.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_494.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2559);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1820,this.var_2558));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1541,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_609 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_609);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1404)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_169);
         }
         if(param1.type == Event.CLOSE && !this.var_2557)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1405);
         ...
         this.var_494 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_494.init(_loc14_);
            _loc15_ = this.var_494.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_910 = _loc14_;
            }
