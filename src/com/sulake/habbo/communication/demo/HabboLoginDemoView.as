package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_502:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_136.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_128,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1541,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1541,"/");
         ...
         {
            dispatchEvent(new Event(const_502));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_119.removeEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
            this.var_119.removeEventListener(SSOTicket.const_260,this.onParsedTicketFailure);
            this.var_119 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_119 = new SSOTicket(this.var_136.assets,_loc3_,_loc2_,param1);
         this.var_119.addEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
         this.var_119.addEventListener(SSOTicket.const_260,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_136.shockwaveClientUrl = this.var_119.shockwaveClientUrl;
         this.var_136.ssoTicket = this.var_119.ticket;
         this.var_119.removeEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
         this.var_119.removeEventListener(SSOTicket.const_260,this.onParsedTicketFailure);
         this.var_119 = null;
         dispatchEvent(new Event(const_502));
