package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_990,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_574,16777215);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1072)
         {
            ...
            if(_loc2_ - this.var_1072 >= this.var_1689)
            {
               _loc3_ = this.var_1073;
               _loc4_ = this.var_1688;
               this.var_1072 = 0;
            }
            else
            {
               _loc7_ = this.var_1327 >> 16 & 255;
               _loc8_ = this.var_1327 >> 8 & 255;
               _loc9_ = this.var_1327 & 255;
               _loc10_ = this.var_1073 >> 16 & 255;
               _loc11_ = this.var_1073 >> 8 & 255;
               _loc12_ = this.var_1073 & 255;
               _loc13_ = (_loc2_ - this.var_1072) / this.var_1689;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1687 + (this.var_1688 - this.var_1687) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_574,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_634:
               param2.setString(RoomObjectVariableEnum.const_704,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_739:
               param2.setString(RoomObjectVariableEnum.const_650,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_729:
               param2.setString(RoomObjectVariableEnum.const_795,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_470:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_800:
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_935:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1079:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_978,int(param1.bgOnly));
         this.var_1327 = this._color;
         this.var_1687 = this.var_1614;
         this.var_1073 = _loc3_;
         this.var_1688 = _loc4_;
         this.var_1072 = getTimer();
         this.var_1689 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_497,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1476,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1433,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1448,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_497,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_158 || _loc13_ == RoomPlaneData.const_289)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
