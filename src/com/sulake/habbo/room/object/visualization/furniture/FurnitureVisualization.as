package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1533:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2651:Number = NaN;
      
      protected var var_2652:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1180:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1658 != spriteCount)
         {
            createSprites(this.var_1658);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2652,param2);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_416 != _loc3_.getUpdateID() || param1 != var_215 || param2 != this.var_2651)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2652 = _loc3_.getNumber(RoomObjectVariableEnum.const_212);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_261));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1180 = _loc3_.getString(RoomObjectVariableEnum.const_368);
            if(this.var_1180 == null || this.var_1180.indexOf("http") != 0)
            {
               this.var_1180 = null;
            }
      ...
      {
         if(this.var_2268 != param1 || this.var_2267 != param2)
         {
            this.var_864 = [];
            this.var_865 = [];
            this.var_695 = [];
            ...
            this.var_1658 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_945.length)
         {
            return "";
         }
         var _loc3_:String = this.var_864[param1];
         var _loc4_:Boolean = this.var_865[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_945[param1];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_864[param1] = _loc3_;
            this.var_865[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_698[param1] != null && !this.var_1659)
         {
