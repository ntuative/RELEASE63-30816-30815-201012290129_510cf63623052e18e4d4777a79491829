package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1389:String = "cone";
      
      public static const const_1255:String = "plane";
      
      public static const const_1316:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_809 = 0;
         this.var_816 = false;
         this.init(0,0,0,this._direction,this.var_2100,this.var_810,this.var_2096,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1006.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_816 = true;
         if(this.var_809 < this.var_1240)
         {
            if(this.age > 1)
            {
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1006.length);
         return this.var_1006[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_809 < this.var_1240)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_809 < this.var_1240)
         {
            ...
            this.y = (2 - this.var_227) * this.y - (1 - this.var_227) * this.lastY + this.var_1533 * this.var_810 * this.var_810;
         ...
         for each(_loc2_ in this.var_307)
         {
            ...
            _loc2_.y = (2 - this.var_227) * _loc2_.y - (1 - this.var_227) * _loc2_.lastY + this.var_1533 * this.var_810 * this.var_810;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_307.splice(this.var_307.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
