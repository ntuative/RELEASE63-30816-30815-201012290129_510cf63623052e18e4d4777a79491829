package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_1752:int = 0;
      ...
      public function getStartFrame() : int
      {
         ...
         return Math.random() * this.var_397;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc11_ > this.var_397)
         {
            this.var_397 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc3_:AnimationLayerData = this.var_112.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:AnimationLayerData = this.var_112.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
