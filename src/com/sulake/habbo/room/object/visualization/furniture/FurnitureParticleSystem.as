package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_671:ColorTransform;
      
      private var var_1245:ColorTransform;
      
      private var var_1536:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_640:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_671 = new ColorTransform();
         this.var_671.alphaMultiplier = 1;
         this.var_1245 = new ColorTransform();
         this.var_1536 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_92 = this.var_1009[param1];
         this.var_816 = false;
         this.method_2();
      }
      ...
      private function method_2() : void
      {
         ...
         if(this.var_1535 >= 0)
         {
            this.var_228 = this._visualization.getSprite(this.var_1535);
            if(this.var_228 && this.var_228.asset)
            {
               ...
               if(this.var_80 == null)
               {
                  this.var_80 = this.var_228.asset.clone();
                  if(this.var_671.alphaMultiplier != 1)
                  {
                     this.var_542 = new BitmapData(this.var_80.width,this.var_80.height,true,4278190080);
                  }
               }
               this.var_2107 = -this.var_228.offsetX;
               this.var_2106 = -this.var_228.offsetY;
               this.var_228.asset = this.var_80;
            }
            if(this.var_80)
            {
               this.var_80.fillRect(this.var_80.rect,4278190080);
            }
            if(this.var_542)
            {
               this.var_542.fillRect(this.var_542.rect,4278190080);
            }
         }
      }
      ...
      {
         if(this.var_92 && this.var_92.roomObjectSpriteId == param1)
         {
            return this.var_92.y * this.var_1010;
         }
         return 0;
      }
      ...
      {
         if(!this.var_92 || !this.var_228)
         {
            return;
         }
         if(this.var_80 && this.var_228.asset != this.var_80)
         {
            this.var_228.asset = this.var_80;
         }
         if(this.var_816)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_816 && this.var_92.hasIgnited)
         {
            this.var_816 = true;
         }
         _loc8_ = this.var_990 * this.var_1010;
         this.var_92.update();
         if(this.var_816)
         {
            if(this.var_92.roomObjectSpriteId >= 0)
            ...
            {
               this.var_80.draw(this.var_542,this.var_1536,this.var_671,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_92.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2107 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1010;
               _loc4_ = this.var_2106 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1010;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_80.draw(_loc7_,this._translationMatrix,this.var_1245,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
                     _loc10_ = new Point(_loc3_ + _loc6_.offsetX,_loc4_ + _loc6_.offsetY);
                     this.var_80.copyPixels(_loc7_,_loc7_.rect,_loc10_,null,null,true);
                  }
               }
               else
               {
                  _loc5_ = new Rectangle(_loc3_ - 1,_loc4_ - 1,2,2);
                  this.var_80.fillRect(_loc5_,4294967295);
               }
            }
            this.var_80.unlock();
         }
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2105 = parseInt(param1.@size);
         this.var_1535 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_990 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1010 = this.var_2105 / 64;
         this.var_640 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_640 = Math.min(this.var_640,1);
         this.var_671.alphaMultiplier = this.var_640;
