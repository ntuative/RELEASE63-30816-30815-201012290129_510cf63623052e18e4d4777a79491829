package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_210:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_210 = this.var_611[param1];
               _loc3_ = true;
            }
            else if(param1 != var_215)
            {
               if(this.var_210)
               {
                  this.var_210.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_210)
         {
            this.var_210.setAnimation(param1);
         }
      ...
      {
         if(this.var_210 && this.var_210.controlsSprite(param1))
         {
            return this.var_210.getSpriteYOffset(param1,param2,param3);
         }
