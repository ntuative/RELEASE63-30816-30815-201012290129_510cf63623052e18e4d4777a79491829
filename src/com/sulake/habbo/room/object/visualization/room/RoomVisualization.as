package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1439:int = 13421772;
      
      private static const const_882:int = 16777215;
      
      private static const const_883:int = 13421772;
      
      private static const const_885:int = 10066329;
      
      private static const const_884:int = 10066329;
      
      public static const const_1327:int = 16777215;
      
      public static const const_1451:int = 13421772;
      
      public static const const_1445:int = 10066329;
      ...
      private const const_1860:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_287["null"] = false;
         this.var_287["null"] = true;
         this.var_287["null"] = true;
         this.var_287["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_117.length)
            {
               _loc4_ = this.var_117[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_117.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_117[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_990);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1280)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_102,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1860 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_614[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_346[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_90)
               {
                  if(this.var_1833)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2576 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2575 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2573 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1582)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1357 || _loc3_.y != this.var_2405 || _loc3_.z != this.var_2406 || param1.scale != this.var_2403))
            {
               this.var_1357 = _loc3_.x;
               this.var_2405 = _loc3_.y;
               this.var_2406 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2574)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2574 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_574));
            if(_loc4_ != this.var_1151)
            {
               this.var_1151 = _loc4_;
               this.var_2576 = this.var_1151 & 255;
               this.var_2575 = this.var_1151 >> 8 & 255;
               this.var_2573 = this.var_1151 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_978));
            if(_loc5_ != this.var_1833)
            {
               this.var_1833 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_650);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_704);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_795);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_731));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_814));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_799));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_117[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_287["null"] || param2 != this.var_287["null"] || param3 != this.var_287["null"])
         {
            this.var_287["null"] = param1;
            this.var_287["null"] = param2;
            this.var_287["null"] = param3;
            this.var_346 = [];
            this.var_614 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_346;
         if(this.var_346.length == 0)
         {
            _loc6_ = this.var_117;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_346.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_287[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_346.push(_loc12_);
                        this.var_614.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1705;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         {
            _loc3_ = this.var_117[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_499.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               {
                  _loc3_ = this.var_117[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_102 || _loc3_.type == RoomPlane.const_90)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_102 || _loc3_.type == RoomPlane.const_90 && _loc12_ == RoomPlaneBitmapMaskData.const_236)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_117[_loc18_] as RoomPlane;
