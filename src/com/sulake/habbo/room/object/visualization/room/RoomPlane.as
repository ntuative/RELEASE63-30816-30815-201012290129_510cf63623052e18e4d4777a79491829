package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_854:IPlaneRasterizer = null;
      
      private var var_755:PlaneMaskManager = null;
      ...
      private var var_383:PlaneBitmapData = null;
      ...
      private var var_196:BitmapData = null;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_854.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_383;
         if(_loc3_ == null)
         {
         ...
         if(this.var_690 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_319))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_278.length * param1.scale;
            ...
            if(this.var_854 != null)
            {
               _loc3_ = this.var_854.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1635,this.var_2256,this.var_2253,this.var_2257,this.var_2255,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1582 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1289.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1289[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_142.z - originZ,this.var_107.z - originZ,this.var_81.z - originZ,this.var_106.z - originZ);
            if(this._type == const_90)
            {
               relativeDepth += 0.02;
            }
            this.var_2252 = relativeDepth;
            this._isVisible = true;
            this.var_1582 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2254);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_102 || this._type == const_90)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_102 || this._type == const_90))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_856)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_318.length)
            {
               _loc5_ = this.var_318[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_235.length == this.var_855.length)
         {
            while(_loc1_ < this.var_235.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_855[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_318.length > this.var_1303.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_856 || this.var_235.length == 0 && this.var_318.length == 0 && !this.var_319 || this.var_755 == null)
         {
            return;
         }
         ...
         if(this.var_319)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_564);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_235.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc3_.leftSideLoc / this.var_278.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc3_.rightSideLoc / this.var_277.length;
                  _loc12_ = _loc3_.type;
                  this.var_755.updateMask(this.var_65,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_855.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_318.length)
            {
               _loc4_ = this.var_318[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc4_.leftSideLoc / this.var_278.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc4_.rightSideLoc / this.var_277.length;
                  _loc13_ = this.var_65.width * _loc4_.leftSideLength / this.var_278.length;
                  _loc14_ = this.var_65.height * _loc4_.rightSideLength / this.var_277.length;
                  this.var_65.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1303.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_319 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_196 != null && (this.var_196.width != param1.width || this.var_196.height != param1.height))
         {
            this.var_196.dispose();
            this.var_196 = null;
         }
         if(this.var_196 == null)
         {
            this.var_196 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_196.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_196.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_196,this.var_196.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
