package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_549:String = "temporary_room";
      
      private static const const_310:int = -1;
      
      private static const const_550:String = "room";
      
      private static const const_836:int = -2;
      
      private static const const_1148:String = "tile_cursor";
      
      private static const const_835:int = -3;
      
      private static const const_1149:String = "selection_arrow";
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_651 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_798.release(new IIDRoomRendererFactory());
            this.var_798 = null;
         }
         ...
         while(_loc2_ < this.var_301.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_94 || _loc6_ != this.var_95 || !this.var_979)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_693) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_608) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_576) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_575) + 0.5;
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_41 != null)
         {
            ...
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_302);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_71);
            this.var_41.setContentLoader(this.var_14);
         }
         this.initializeRoomManager();
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_798 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_767,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_767)
         {
            this.var_1995 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_266.events.addEventListener(AdEvent.const_460,this.showRoomAd);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_23 != null)
         {
            ...
            {
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_214,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_472,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_454,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_137,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_684,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_134,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_463,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_540,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_518,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_450,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_468,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_478,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_490,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_487,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_421,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_274,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_403,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_321,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_355,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_420,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_952,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_524,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_23 == null || this.var_443 == null || this.var_41 == null || this.var_798 == null || this._communication == null || this._habboConfiguration == null || !this.var_1995)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_435 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_747,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_302.length)
            {
               _loc3_ = this.var_302.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1087,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1087);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_435)
         {
            _loc5_ = this.var_302.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_302.add(_loc4_,_loc5_);
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_562,1,true);
            _loc13_ = parseInt(this._habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_942,_loc13_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_310,const_550,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_562,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_668,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_693,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_576,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_608,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_575,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_634,param3);
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_470,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_236);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_685,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_595,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_685,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_966,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_923,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_836,const_1148,RoomObjectCategoryEnum.const_302);
         _loc7_.createRoomObject(const_835,const_1149,RoomObjectCategoryEnum.const_302);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_310,RoomObjectCategoryEnum.const_71);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_302.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_302.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_634,param3);
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1287,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1079,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_935,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_784,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_798.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_903;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_668);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_595);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_685);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_966);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_923);
      ...
      {
         var _loc8_:int = param2 - this.var_1224;
         var _loc9_:int = param3 - this.var_1225;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_979 = true;
               this.var_799 = false;
               this.var_1996 = this.var_1224;
               this.var_1997 = this.var_1225;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_979)
            {
               if(!this.var_799)
               {
                  _loc8_ = param2 - this.var_1996;
                  _loc9_ = param3 - this.var_1997;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_429,this.var_94,this.var_95,-1,RoomObjectCategoryEnum.const_148));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_68 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_310,const_550);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_94,this.var_95,this.var_1223);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1224 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1225 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_94,this.var_95,this.var_1223);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_94,this.var_95,this.var_1223);
         if(_loc1_ != null)
         {
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_562) != 0)
         {
            return false;
         }
         if(this.var_68 != null)
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_835,RoomObjectCategoryEnum.const_302);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_836,RoomObjectCategoryEnum.const_302);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_368,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1072,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_979,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1061,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_368,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_903,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_915) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1022);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_470,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_800,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_741,this.var_94,this.var_95,param2,param3));
            }
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_530);
                     break;
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = this.var_41.getRoom(const_549);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_41.createRoom(const_549,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_651.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_530,param8);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_185,param2);
               break;
            case RoomObjectCategoryEnum.const_71:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_704,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_650,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_795,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_470,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            this.var_978.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_986,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_651.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_94,this.var_95,const_310,RoomObjectCategoryEnum.const_71,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_41.getRoom(const_549);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_986);
               ...
               this.var_651.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_978.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_359,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_901,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1038,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_940,RoomObjectVariableEnum.const_359,param1.clickUrl);
