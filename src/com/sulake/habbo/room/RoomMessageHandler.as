package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1317:int = -1.0E9;
      
      private var var_704:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_704 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_704.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_704.objectData);
            this.var_704.objectData = null;
         }
         else
         {
            this.var_704.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_704.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_704.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_668);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1028:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1106:
                     _loc10_ = "std";
               }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         this.var_12.updateObjectUserState(_loc2_.roomId,_loc2_.roomCategory,_loc2_.method_9,_loc3_);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1112,_loc3_.status);
         }
      }
