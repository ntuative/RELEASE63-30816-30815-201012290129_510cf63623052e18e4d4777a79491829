package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1137:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1213:XML;
      
      private static var var_1212:XML;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1462 == 4294967295)
            {
               this.var_1462 = _loc1_.color;
            }
            _loc1_.color = const_1137;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1525;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1517;
            }
         }
      }
      ...
      {
         this.var_53 = navigator.catalog.windowManager.buildFromXML(var_1212) as IItemListWindow;
         if(this.var_53 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1213) as IWindowContainer;
         }
         else
         {
