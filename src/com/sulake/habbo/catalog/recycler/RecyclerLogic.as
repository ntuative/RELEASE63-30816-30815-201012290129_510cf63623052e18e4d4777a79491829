package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_585 != const_871;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1731 != RecyclerStatusMessageEvent.const_929;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_585 == const_394;
      }
      ...
      {
         this.var_585 = const_870;
         this.var_109 = new Array(const_173);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1731)
         {
            case RecyclerStatusMessageEvent.const_1483:
               this.var_585 = const_394;
               if(this._view == null)
               {
                  return;
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_109.length < const_173)
         {
            return false;
         }
         var _loc1_:int = 0;
