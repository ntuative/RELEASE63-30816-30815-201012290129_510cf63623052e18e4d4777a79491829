package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      {
         this.var_886 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1100 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1716 = new Point(this.var_83.x,this.var_83.y);
         ...
         this.var_1715 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_886.text = _loc4_;
         this.var_1100.text = _loc5_;
         this.var_886.height = this.var_886.textHeight + 5;
         this.var_1100.y = this.var_886.y + this.var_886.height;
         this.var_1100.height = Math.max(130,this.var_1100.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_402:
                  _loc6_ = this.var_1715.clone();
                  if(this.var_476 != null)
                  {
                     this.var_476.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_476,this.var_1353,this.var_1583);
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_292,AvatarAction.const_541);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2383)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1716.x;
            this.var_83.y = this.var_1716.y;
            if(param3 != null)
            {
