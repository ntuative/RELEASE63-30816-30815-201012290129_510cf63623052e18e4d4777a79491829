   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_614,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_184.stop();
            this.var_184.removeEventListener(TimerEvent.TIMER,this.populateItemGrid);
            this.var_184 = null;
         }
      ...
      override public function init() : void
      {
         ...
         if(this.var_178)
         {
            this.var_184 = new Timer(25);
            this.var_184.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_184.start();
         }
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            ...
            {
               _loc4_ = page.offers[this.var_861];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++this.var_1649;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1649);
         }
      }
