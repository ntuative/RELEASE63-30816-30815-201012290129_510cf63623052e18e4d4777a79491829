package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1077.removeEventListener(WindowKeyboardEvent.const_150,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(this.var_1077 != null)
         {
            this.var_1077.addEventListener(WindowKeyboardEvent.const_150,this.windowKeyEventProcessor);
         }
      }
