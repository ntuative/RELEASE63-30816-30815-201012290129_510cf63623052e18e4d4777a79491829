package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_604[this.var_1139][this.var_1780];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1139 = var_1179.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1139];
         var _loc3_:Array = this.var_604[this.var_1139] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1780 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1780] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_499 || _loc1_.pricingModel == Offer.const_459)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_76 || _loc3_.productType == ProductTypeEnum.const_82)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_604.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_604[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
