package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_998 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_998 != null)
         {
            this.var_998.addEventListener(WindowKeyboardEvent.const_354,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_998.text));
      }
   }
}
