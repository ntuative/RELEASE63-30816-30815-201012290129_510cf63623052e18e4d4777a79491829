package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1552:int = 1;
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1003.add(MarketPlaceOfferState.const_981,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1003.add(MarketPlaceOfferState.const_452,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1003.add(MarketPlaceOfferState.const_183,_loc2_);
            }
         }
         this.marketPlace.registerVisualization(this);
         this.displayMainView();
         this.marketPlace.requestOwnItems();
         this.updateStatusDisplay(this.const_1552);
      ...
      private function updateList(param1:Map) : void
      {
         ...
         this.updateStatusDisplay(this.const_1553,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc10_ = _loc6_[_loc7_];
            _loc11_ = param1.getValue(_loc10_) as MarketPlaceOfferData;
            if(_loc11_.status == MarketPlaceOfferState.const_452)
            {
               _loc5_++;
            }
            _loc4_ = this.var_1003.getValue(_loc11_.status);
            if(_loc4_)
            {
