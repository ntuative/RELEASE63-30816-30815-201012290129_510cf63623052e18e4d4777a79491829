package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1549:uint = 4.293848814E9;
      
      private const const_1548:uint = 4.294967295E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_203:
                  ...
                  break;
               case ProductTypeEnum.const_357:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1585 = _loc1_.stuffTypes;
            this.var_731 = _loc1_.boxTypes;
            this.var_732 = _loc1_.ribbonTypes;
            this.var_1129 = this.var_1585[0];
            this.var_336 = this.var_731[0];
            this.var_337 = this.var_732[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_337 < 0)
         {
            this.var_337 = this.var_732.length - 1;
         }
         if(this.var_337 > this.var_732.length - 1)
         {
            this.var_337 = 0;
         }
         if(this.var_336 < 0)
         {
            this.var_336 = this.var_731.length - 1;
         }
         if(this.var_336 > this.var_731.length - 1)
         {
            this.var_336 = 0;
         }
         var _loc1_:int = this.var_731[this.var_336] * 1000 + this.var_732[this.var_337];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1129,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1384 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1585;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1129);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_731[this.var_336]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_732[this.var_337]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1383,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1383);
               this.dispose();
               break;
            case "cancel_button":
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1549) : uint(this.const_1548);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1129;
               }
            }
            _loc4_++;
         }
