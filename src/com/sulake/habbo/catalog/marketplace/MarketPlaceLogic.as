package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1719:int = 2;
      
      public const const_1869:int = 3;
      ...
      {
         this.requestOffers(this.var_2244,this.var_2238,this.var_1984,this.var_2242);
      }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = this.var_195.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_195.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_452)
            {
               this.var_195.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_195)
         {
            for each(_loc5_ in this.var_195)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         this.var_1989 = _loc3_.creditsWaiting;
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_195.add(_loc4_.offerId,_loc6_);
         }
         if(this._visualization == null)
         {
            return;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1719,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_195.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2241 || param1.furniTypeId != this.var_2239)
         {
            return;
         }
      ...
      private function method_4(param1:IMarketPlaceOfferData) : Boolean
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
