package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_2312:GiftWrappingConfiguration;
      
      private var var_1067:ClubGiftController;
      
      private var var_471:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.var_471.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_108.getActivityPointsForType(Purse.const_495)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_664)
         {
            if(!this.var_387.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_323.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_323 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_323.habboCatalog = this;
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1067 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_471 == null)
         {
            this.var_471 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_706 && this.var_706 != "")
         {
            this.var_324.openPage(this.var_706);
            this.var_706 = "";
            this.var_870 = -1;
         }
         else if(this.var_870 > -1)
         {
            this.var_324.openPageById(this.var_870,this.var_1682);
            this.var_870 = -1;
            this.var_1682 = -1;
            this.var_706 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_323.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_323.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2311 && this.var_574 != null)
         {
            this.var_574.playSound(HabboSoundTypesEnum.const_1084);
         }
         this.var_2311 = false;
         if(this.var_275 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2313 && this.var_574 != null)
         {
            this.var_574.playSound(HabboSoundTypesEnum.const_907);
         }
         this.var_2313 = false;
         if(this.var_275 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1067.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_323.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2312 = new GiftWrappingConfiguration(param1);
      }
