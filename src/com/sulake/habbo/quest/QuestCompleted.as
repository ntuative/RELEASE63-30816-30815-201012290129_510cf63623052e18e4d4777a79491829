package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_204 = IFrameWindow(this.var_67.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_204.findChildByName("description").caption = this.var_67.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_204.findChildByName("reward.currency.desc").caption = this.var_67.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
