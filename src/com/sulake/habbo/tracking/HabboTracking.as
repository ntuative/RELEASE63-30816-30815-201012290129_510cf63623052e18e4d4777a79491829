package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1157:IHabboWindowManager;
      ...
      private var var_252:PerformanceTracker = null;
      
      private var var_618:FramerateTracker = null;
      
      private var var_253:LatencyTracker = null;
      
      private var var_616:LagWarningLogger = null;
      
      private var var_617:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_252 = new PerformanceTracker();
         this.var_618 = new FramerateTracker();
         this.var_253 = new LatencyTracker();
         this.var_616 = new LagWarningLogger();
         this.var_617 = new ToolbarClickTracker(this);
         this.var_1419 = new Array(const_887);
         var _loc4_:int = 0;
         while(_loc4_ < const_887)
         {
            this.var_1419[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1269,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1260,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1305,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_692,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1093,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1157)
            {
               this.var_1157.release(new IIDHabboWindowManager());
               this.var_1157 = null;
            }
            if(this.var_266)
            {
            ...
            if(this.var_186)
            {
               if(!this.var_186.disposed)
               {
                  ...
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.const_332,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_156)
            {
               if(!this.var_156.disposed)
               {
                  this.var_156.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_156.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_156.release(new IIDHabboHelp());
               this.var_156 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_253 != null)
            {
               this.var_253.configuration = this._configuration;
            }
            if(this.var_252 != null)
            {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_816,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_169,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_763,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_436,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_763)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1490);
         }
         else if(param1.type == HabboHotelViewEvent.const_436)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_816:
               this.trackLoginStep(HabboLoginTrackingStep.const_1286,String(this._communication.port));
               break;
      ...
      {
         this.var_1157 = IHabboWindowManager(param2);
         if(this.var_1157)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1419)
                  {
                  ...
                  if(this.var_252 != null)
                  {
                     _loc4_["null"] = this.var_252.flashVersion;
                     _loc4_["null"] = this.var_252.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1002);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1002,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.const_332,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_156 = param2 as IHabboHelp;
         this.var_156.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_156.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1093,String(_loc2_.guestRoomId));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_266.events.addEventListener(AdEvent.const_460,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_617)
         {
            this.var_617.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1845;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1845);
         }
         if(this.var_503 > -1 && _loc2_ - this.var_503 > 15000)
         {
            ++this.var_1844;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1844);
         }
         this.var_503 = _loc2_;
         if(this.var_252 != null)
         {
         ...
         if(this.var_253 != null)
         {
            this.var_253.update(param1,this.var_503);
         }
         if(this.var_618 != null)
         {
            this.var_618.trackUpdate(param1,this,this.var_503);
         }
         if(this.var_616 != null)
         {
            this.var_616.update(this.var_503);
         }
      }
   }
}
