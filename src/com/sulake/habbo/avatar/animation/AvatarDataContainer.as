package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1643:Number = 1.0;
      ...
      {
         super();
         this.var_1495 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2023 = parseInt(_loc2_,16);
         this.var_2024 = parseInt(_loc3_,16);
         ...
         this.var_1538 = new ColorTransform(this.var_1643,this.var_1641,this.var_1644,this._alphaMultiplier);
         this.var_987 = this.generatePaletteMapForGrayscale(this.var_2024,this.var_2023);
      }
      ...
      {
         return this.var_987.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_987.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_987.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_987.getValue("alphas") as Array;
      }
