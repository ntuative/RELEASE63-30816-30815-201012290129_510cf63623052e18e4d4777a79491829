package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1167:IWindowContainer;
      
      public static var var_1427:IWindowContainer;
      
      public static var var_1886:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1034 = [];
         this.var_1278 = [AvatarEditorFigureCategory.const_720,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_241,AvatarEditorFigureCategory.const_806,AvatarEditorFigureCategory.const_1057,AvatarEditorFigureCategory.const_100];
         super();
         ...
         if(var_1167 == null)
         {
            ...
            var_1167 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1427 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1427 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_376 = new Timer(1000);
         this.var_376.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1278;
         }
         for each(_loc6_ in param4)
         {
            this.var_1034.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_376.stop();
            this.var_376.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_376 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1278);
         }
         if(param1.length != this.var_1034.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1034.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2193 = this.canChangeOutfit();
            this.var_376.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1034.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1278;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1591 == AvatarEditorSideCategory.const_100 || this.var_2192))
         {
      ...
      {
         if(this.var_1591 == AvatarEditorSideCategory.const_100)
         {
            this.var_2192 = false;
            this.setSideContent(AvatarEditorSideCategory.const_566);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_566:
               break;
