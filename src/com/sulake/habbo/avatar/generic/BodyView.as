package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_561:String = "tab_boy";
      
      private const const_560:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_63.controller.gender)
         {
            case FigureData.const_68:
               activateTab(this.const_561);
               inactivateTab(this.const_560);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_560);
               inactivateTab(this.const_561);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_561:
                  var_63.controller.gender = FigureData.const_68;
