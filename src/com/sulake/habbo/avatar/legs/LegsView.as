   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_253,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_252,_windowManager,_assetLibrary);
         }
         else
         {
