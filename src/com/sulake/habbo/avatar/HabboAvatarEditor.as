package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1193:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1192:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_705:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1059:AvatarEditorHandler;
      ...
      private var var_860:IFigureData;
      ...
      private var var_1308:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_849 = FigureData.const_68;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_93 != null)
         {
            for each(_loc1_ in this.var_93)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      private function init() : void
      {
         ...
         if(!this.var_173)
         {
            ...
            _loc1_.loadAvatarData(const_1193,FigureData.const_68);
            _loc2_.loadAvatarData(const_1192,FigureData.FEMALE);
            this.var_93 = new Map();
            this.var_469 = new Map();
            this.var_93.add(AvatarEditorFigureCategory.const_720,new BodyModel(this));
            this.var_93.add(AvatarEditorFigureCategory.const_43,new HeadModel(this));
            this.var_93.add(AvatarEditorFigureCategory.const_241,new TorsoModel(this));
            this.var_93.add(AvatarEditorFigureCategory.const_806,new LegsModel(this));
            this.var_93.add(AvatarEditorFigureCategory.const_1057,new HotLooksModel(this));
            this.var_469.add(AvatarEditorSideCategory.const_100,new WardrobeModel(this));
            this.var_469.add(AvatarEditorSideCategory.const_432,new ClubPromoModel(this));
            this.var_173 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_93)
         {
            for each(_loc5_ in this.var_93)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_860.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_860.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_236 == null)
            {
               this.var_236 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_236.addChild(this._view.window);
               if(param5)
               {
                  this.var_236.center();
               }
            ...
            this.var_236.visible = !this.var_236.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_720);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_93.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_469.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_705 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_468 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_860 = this.var_468.getFigureData(AvatarType.const_110);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1059 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_566[this.var_849];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1308 != null)
         {
            ...
            this.var_1308.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1648;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1060 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1194)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1427.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_468.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_468.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1167.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1523)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1060 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1167.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1060 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_469.getValue(AvatarEditorSideCategory.const_100);
      }
