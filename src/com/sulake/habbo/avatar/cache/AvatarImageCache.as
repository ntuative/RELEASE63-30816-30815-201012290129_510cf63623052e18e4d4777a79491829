package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_1351:IAvatarImage;
      ...
      private var var_80:AvatarCanvas;
      ...
      private var var_388:AvatarImageBodyPartContainer;
      
      private var var_1406:String;
      
      private var var_111:AvatarImagePartContainer;
      
      private var var_2561:Point;
      ...
      private var var_403:BitmapDataAsset;
      
      private var var_911:BitmapData;
      
      private var var_2560:ByteArray;
      
      private var var_2562:ImageData;
      
      private var var_1821:PaletteMap;
      ...
      {
         if(this.var_745 == param1)
         {
            return;
         }
         if(this.var_745 == GeometryType.const_1043 && param1 == GeometryType.const_1011 || this.var_745 == GeometryType.const_1011 && param1 == GeometryType.const_1043)
         {
            this.var_745 = param1;
            this.var_80 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_345.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_618)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1351.getFigure(),_loc5_,this.var_745,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_388 = _loc10_.getImageContainer(_loc4_);
         if(this.var_388 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_388 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_345);
            if(this.var_388 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_388,_loc4_);
         }
         this.var_388.offset = _loc8_;
         return this.var_388;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_80)
         {
            this.var_80 = this._structure.getCanvas(this._scale,this.var_745);
            if(!this.var_80)
            {
               return null;
            }
            this.var_2561 = new Point(0,this.var_80.height - int(this.var_80.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1502[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_759 || _loc10_ == AvatarAction.const_330;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1406 = this.var_111.bodyPartId;
               this.var_169 = this.var_111.partType;
               this.var_1822 = this.var_111.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_111.flippedPartType != this.var_169)
                     {
                        this.var_169 = this.var_111.flippedPartType;
                     }
                  }
               }
               this.var_1407 = this._scale + "_" + this.var_111.action.assetPartDefinition + "_" + this.var_169 + "_" + this.var_1822 + "_" + _loc5_ + "_" + this._frame;
               this.var_403 = this._assets.getAssetByName(this.var_1407) as BitmapDataAsset;
               if(this.var_403 == null)
               {
                  this.var_1407 = this._scale + "_std_" + this.var_169 + "_" + this.var_1822 + "_" + _loc5_ + "_0";
                  this.var_403 = this._assets.getAssetByName(this.var_1407) as BitmapDataAsset;
               }
               if(!(!this.var_403 || !this.var_403.content))
               {
                  if(this.var_111.paletteMapId > -1)
                  {
                     this.var_1821 = this._structure.renderManager.paletteManager.getPalette(this.var_111.paletteMapId);
                     if(this.var_1821 != null)
                     {
                        this.var_911 = this.var_403.content as BitmapData;
                        this.var_170 = new BitmapData(this.var_911.width,this.var_911.height);
                        this.var_2560 = this.var_1821.colorize(this.var_911.getPixels(this.var_911.rect));
                        this.var_170.setPixels(this.var_170.rect,this.var_2560);
                     }
                     else
                     {
                        this.var_170 = (this.var_403.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1406 == AvatarBodyPartType.const_241 || this.var_1406 == AvatarBodyPartType.const_1461 || this.var_1406 == AvatarBodyPartType.const_1341) && this.var_111.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_170.colorTransform(this.var_170.rect,this.var_111.color.colorTransform);
                  }
                  if(this.var_111.isBlendable)
                  {
                     this.var_170.colorTransform(this.var_170.rect,this.var_111.blendTransform);
                  }
                  this.var_913 = this.var_403.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_49)
                     {
                  ...
                  this.var_2562 = new ImageData(this.var_170,this.var_913,_loc7_);
                  this.var_912.push(this.var_2562);
               }
            }
            _loc8_--;
         }
         if(this.var_912.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_912,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2561.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_49)
            {
         ...
         _loc8_ = this.var_912.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_912.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
