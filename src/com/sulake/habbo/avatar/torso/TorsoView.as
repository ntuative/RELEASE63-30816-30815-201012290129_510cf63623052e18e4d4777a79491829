   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_221,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_160,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_63,FigureData.const_230,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_63 && var_132 == "")
         {
            var_63.switchCategory(FigureData.const_160);
         }
      }
