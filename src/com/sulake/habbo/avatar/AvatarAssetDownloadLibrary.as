package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1630:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1300 = param3 + this.var_853 + ".swf";
         this.var_1300 = this.var_1300.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1630;
         var _loc1_:URLRequest = new URLRequest(this.var_1300);
