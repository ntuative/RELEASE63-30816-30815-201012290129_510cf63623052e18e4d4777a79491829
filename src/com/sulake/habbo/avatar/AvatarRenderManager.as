package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1864:String = "hd-99999-99999";
      ...
      private var var_212:AvatarAssetDownloadManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_548 = RenderMode.const_1456;
         this.var_290 = new Map();
         this.var_98 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_110,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_98.add(AvatarType.const_110,_loc4_);
         ...
         this.var_98.add(AvatarType.const_64,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_98 != null)
         {
            for each(_loc1_ in this.var_98.getValues())
            {
               _loc1_.dispose();
            }
            this.var_98.dispose();
         ...
         if(this.var_212)
         {
            this.var_212.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_348.init();
         this.var_754.init();
         _loc2_ = this.var_98.getValue(AvatarType.const_110) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_98.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_98.getValue(AvatarType.const_110) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_212 == null)
               {
                  ...
                  this.var_212 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_212.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_917)
         {
            if(this.var_2608 && this.var_2610 && this.var_2609)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_212.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_212.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_98.getValue(AvatarType.const_110) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_212.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1848)
         {
            this.var_1848 = new AvatarFigureContainer(this.const_1864);
         }
         this.var_212.loadFigureSetData(_loc6_,param4);
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1399)
         {
            _loc6_ = !this.var_348.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_348.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_98.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_98.getValue(AvatarType.const_64);
      ...
      {
         var _loc2_:AvatarStructure = this.var_98.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_98.getValue(AvatarType.const_110) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_110:
               _loc3_ = this.var_98.getValue(AvatarType.const_110) as AvatarStructure;
               break;
            case AvatarType.const_64:
               _loc3_ = this.var_98.getValue(AvatarType.const_64) as AvatarStructure;
               break;
            default:
