package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2112 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         ...
         {
            this.var_1678.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1678.concat();
         for each(_loc3_ in this.var_1065)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2302 = _loc6_;
      }
