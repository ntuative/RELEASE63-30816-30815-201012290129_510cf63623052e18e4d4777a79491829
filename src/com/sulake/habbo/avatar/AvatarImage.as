package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1131:String = "Default";
      
      private static const const_1130:int = 2;
      
      private static const const_1129:String = AvatarSetType.const_33;
      ...
      private var var_924:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1129,const_1130);
         this.var_292 = new Array();
         this.var_924 = new ActiveActionData(AvatarAction.const_344);
         this.var_924.definition = this._structure.getActionDefinition(const_1131);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_561,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1439;
         if(param2 < AvatarDirectionAngle.const_928)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_520,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_261.length == 1 && this.var_85 == this.var_1892)
         {
            return this.var_85 + this.var_423 + this.var_520 % 4;
         }
         if(this.var_261.length == 2)
         {
            for each(_loc1_ in this.var_261)
            {
               ...
               {
                  return this.var_85 + this.var_423 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_520 % 11;
                  return this.var_85 + "_" + this.var_1892 + this.var_423 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_1917 || param2 != this.var_1916 || param1 != this.var_1918)
         {
            this.var_1917 = param3;
            this.var_1916 = param2;
            this.var_1918 = param1;
            this.var_1438 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_520);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_520);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_292.push(new ActiveActionData(param1,param2,this.var_520));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_256 = this.var_924;
         this.var_256.definition = this.var_924.definition;
         this.resetBodyPartCache(this.var_924);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_423 = "";
         this.var_261 = this._structure.sortActions(this.var_292);
         if(this.var_261 == null)
         {
            this.var_672 = new Array(0,0,0);
            if(this.var_1194 != "")
            {
               _loc1_ = true;
               this.var_1194 = "";
         ...
         {
            this.var_672 = this._structure.getCanvasOffsets(this.var_261,this._scale,this.var_85);
            for each(_loc4_ in this.var_261)
            {
               this.var_423 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_291)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1192 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1192 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1194 != this.var_423)
            {
               _loc1_ = true;
               this.var_1194 = this.var_423;
            }
         }
         this.var_1193 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_261)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_796 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1439 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_297 || _loc1_.actionType == AvatarAction.const_229 || _loc1_.actionType == AvatarAction.const_330)
               {
                  this.var_796 = true;
               }
            }
