package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1581:String = "noconvinfo";
      
      private static const const_1582:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1375:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1375 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_881 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_241 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1375.prepare(this.var_881);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1033,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_967,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_773,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_774,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_773,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_774,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1376 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1376.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1761 == -1 ? 0 : int(this.var_16.height - this.var_1761);
         var _loc4_:int = this.var_1763 == -1 ? 0 : int(this.var_16.width - this.var_1763);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_241.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_893,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_773,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1033,false);
         ...
         this.var_1761 = this.var_16.height;
         this.var_1763 = this.var_16.width;
