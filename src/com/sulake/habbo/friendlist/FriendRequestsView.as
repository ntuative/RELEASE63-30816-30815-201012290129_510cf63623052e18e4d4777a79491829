package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private var var_1587:IContainerButtonWindow;
      ...
      {
         this.var_1587 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1586 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1586.procedure = this.onDismissAllButtonClick;
         this.var_1587.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1108)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_265,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_338 && _loc4_.state != FriendRequest.const_335)
            {
               _loc4_.state = FriendRequest.const_335;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_265,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1587,_loc1_);
         this.setEnabled(this.var_1586,_loc1_);
      }
