package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1026:IAvatarRenderManager;
      
      private var var_705:ISessionDataManager;
      
      private var var_2287:FriendListLookAndFeel;
      
      private var var_366:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1670:OpenedToWebPopup;
      
      private var var_2288:int;
      
      var var_93:FriendCategories;
      
      private var var_322:FriendRequests;
      
      private var var_1671:AvatarSearchResults;
      ...
      {
         this.var_2287 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_93 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1671 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_572.stop();
            this.var_572.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_572 = null;
         }
         ...
         if(this.var_1026)
         {
            this.var_1026.release(new IIDAvatarRenderManager());
            this.var_1026 = null;
         }
         if(this.var_832)
         {
            this.var_832.release(new IIDHabboNotifications());
            this.var_832 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_705)
         {
            this.var_705.release(new IIDSessionDataManager());
            this.var_705 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1670 = new OpenedToWebPopup(this);
         }
         this.var_1670.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_93.findFriend(param1);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_322.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_307,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1026.createAvatarImage(param1,AvatarScaleType.const_86,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1026 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_832 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_322 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_93.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_93.addCategory(new FriendCategory(FriendCategory.const_934,this.getText("friendlist.friends")));
         this.var_93.addCategory(new FriendCategory(FriendCategory.const_334,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_93.addFriend(new Friend(_loc4_));
         }
         this.var_366 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_572)
         {
            this.var_572 = new Timer(120000);
            this.var_572.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_572.start();
         }
         ...
         if(this.var_93.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_93.findCategory(FriendCategory.const_334);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_366.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_322.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_322.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_366.findTab(FriendListTab.const_94).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_322.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_366.findTab(FriendListTab.const_94);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1671.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_93.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_93.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_366.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_705 || !this.var_322)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_705.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_322.vipLimit;
         }
         else if(this.var_705.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_322.clubLimit;
         }
         if(_loc2_ > this.var_322.limit)
         {
            this.var_322.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_93.getAllFriends();
