package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_593:ToolbarBarMenuAnimator;
      ...
      {
         return this.var_1265.indexOf(param1) > -1;
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_675.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_675.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1266.length)
         {
            _loc2_ = this.var_675.indexOf(this.var_1266[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_268[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_988 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_268[this.var_675.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_593);
         this.var_34.addChild(_loc2_.window);
         this.var_675.push(param1);
