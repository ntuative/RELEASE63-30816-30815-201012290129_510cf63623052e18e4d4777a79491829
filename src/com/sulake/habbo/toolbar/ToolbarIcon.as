package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1379:String = "-1";
      
      private var var_1124:String = "-1";
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         this.var_1122 = new ToolbarIconBouncer(0.8,1);
         super();
         this.var_486 = param1;
         ...
         this._events = param5;
         this.var_282 = param6;
         this.var_1380 = new Timer(40,40);
         this.var_1380.addEventListener(TimerEvent.TIMER,this.updateBouncer);
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         this.var_1381 = param1.@id;
         this.var_2464 = int(param1.@window_offset_from_icon);
         this.var_2163 = int(param1.@window_margin);
         this.var_2684 = param1.@label;
         var _loc2_:XMLList = param1.elements("state");
         if(_loc2_.length() > 0)
         {
            if(param1.attribute("state_over").length() > 0)
            {
               this.var_1379 = param1.@state_over;
            }
            if(param1.attribute("state_default").length() > 0)
            {
               this.var_1124 = param1.@state_default;
            }
            _loc3_ = 0;
            while(_loc3_ < _loc2_.length())
            {
               ...
               this.var_1123.push(_loc5_.id);
               this.var_1766.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(this.var_1379 == "-1")
                  {
                     this.var_1379 = _loc5_.id;
                  }
                  if(this.var_1124 == "-1")
                  {
                     this.var_1124 = _loc5_.id;
                  }
               }
               _loc3_++;
            }
         }
         this._state = this.var_1124;
      }
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && this.var_1125)
         {
            ...
            this.var_593 = new ToolbarIconAnimator(_loc1_,this._assetLibrary,this._icon,this._x,this.var_161,this._bitmapData);
            if(this.var_593.frameCount > 0)
            {
               this.var_896 = new Timer(_loc1_.timer);
               this.var_896.addEventListener(TimerEvent.TIMER,this.updateAnimator);
               this.var_896.start();
            }
            if(_loc1_.bounce)
            {
               this.var_1122.reset(-7);
               this.var_1380.reset();
               this.var_1380.start();
            }
         }
      ...
      {
         var _loc4_:* = null;
         if(this.var_729.indexOf(param1) < 0)
         {
            this.var_729.push(param1);
      ...
      {
         return this.var_729.indexOf(param1) > -1;
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = this.var_1126[this.var_729.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         ...
         {
            this.var_282.animateWindowIn(this,param1,param2,this.var_730,param3,param4,this.getMenuYieldList(param1));
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_282 != null)
         {
            this.var_282.positionWindow(this,param1,param2,this.var_730,param3,this.getMenuYieldList(param1));
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_282 != null)
         {
            this.var_282.hideWindow(param1,param2,this.var_730,param3);
         }
      }
      ...
      {
         return this.var_1766[this.var_1123.indexOf(param1)];
      }
      ...
      private function setTooltip() : void
      {
         ...
         {
            this._region.toolTipCaption = "${toolbar.icon.tooltip." + this.var_1381.toLowerCase() + "}";
         }
      ...
      private function setLabel() : void
      {
         ...
         {
            this.var_333.caption = "${toolbar.icon.label." + this.var_1381.toLowerCase() + "}";
         }
         this.updateRegion();
      }
      ...
      {
         return this.var_2163 + this.var_486.windowMargin;
      }
      ...
      {
         if(this.var_1122 != null && this._icon != null)
         {
            this.var_1122.update();
            this._icon.y = this.var_1122.location;
         }
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(this.var_282)
               {
                  this.var_282.repositionWindow(this.var_730,true);
               }
               if(this._events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_39);
                  _loc4_.iconId = this.var_730;
                  _loc4_.iconName = this.var_1381;
      ...
      private function updateRegion() : void
      {
         ...
         var _loc1_:Boolean = this.var_486.orientation == "LEFT" || this.var_486.orientation == "RIGHT";
         if(_loc1_)
         {
            this._x = (this.var_486.toolbarUsableWidth - this._region.width) / 2;
            this.var_161 = this.var_988 + (this.var_486.iconSize - this._region.height) / 2;
         }
         else
         {
            this._x = this.var_988 + (this.var_486.iconSize - this._region.width) / 2;
            this.var_161 = (this.var_486.toolbarUsableWidth - this._region.height) / 2;
         }
