package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_146 = this._window.width;
         this.var_202 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_54,HabboWindowStyle.const_1042,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1074 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1074)
         {
         ...
         this.var_1075 = _loc6_.toolbar.@margin_top;
         this.var_1335 = _loc6_.toolbar.@margin_bottom;
         this.var_1693 = _loc6_.toolbar.@min_group_margin;
         this.var_1694 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_242,param1,param2,this._window,this.var_282);
         this.createGroupsFromXmlList(_loc8_,this.var_576,param1,param2,this.var_202,this.var_282);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_146);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_146,this.var_473,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_146,this.var_473);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_146,this.var_473);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_202 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_202.x = this.var_146 + this.var_1694;
               this.var_202.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_146;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_146;
               this._window.y = 0;
               this.var_202.x = 0;
               this.var_202.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_146;
               this._window.x = 0;
               this._window.y = 0;
               this.var_202.x = 0;
               this.var_202.y = this.var_146 + this.var_1694;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_146;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_146;
               this.var_202.x = 0;
               this.var_202.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1335;
         _loc4_ -= this.var_1075;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1075;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_242.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1693,(this._window.height - _loc5_ * _loc8_ - this.var_1075 - this.var_1335) / (this.var_242.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1693,(this._window.width - _loc5_ * _loc8_ - this.var_1075 - this.var_1335) / (this.var_242.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1074 && this.var_1334)
         {
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_146)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_146)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_146)
         {
            return "BOTTOM";
         }
         return null;
