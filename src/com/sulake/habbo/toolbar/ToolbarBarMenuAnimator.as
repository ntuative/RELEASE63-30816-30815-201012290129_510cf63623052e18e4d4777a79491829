package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1146:Number = 25;
      
      private static const const_1144:Number = 90;
      
      private static const const_875:int = 50;
      ...
      private var var_1390:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_601 = new Object();
         this.var_603 = new Array();
         this.var_602 = new Array();
         super();
         this._windowManager = param1;
         this.var_1390 = param2;
         this.var_735 = new Timer(const_1146);
         this.var_735.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_875 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_875 || param1.desktop.height - param1.y < const_1240;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1390.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1390.getIconLoc(param1.iconId);
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_380,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_601[_loc3_] == null)
            {
               this.var_601[_loc3_] = new Array();
            }
            if(this.var_601[_loc3_].indexOf(param1) < 0)
            {
               this.var_601[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_603.length)
         {
            if(this.var_603[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_601[_loc3_].length)
                  {
                     this.repositionWindow(this.var_601[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
