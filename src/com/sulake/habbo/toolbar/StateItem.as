package com.sulake.habbo.toolbar
{
   public class StateItem
   {
      ...
      private var var_1485:String = "-1";
      
      private var var_1504:String = "-1";
      ...
      public function StateItem(param1:XML, param2:String)
      {
         ...
         {
            this.var_1386 = Boolean(param1.@loop);
         }
         if(param1.attribute("bounce").length() > 0)
         {
            this.var_2041 = Boolean(param1.@loop);
         }
         if(param1.attribute("timer").length() > 0)
         {
            this.var_184 = int(param1.@timer);
         }
         if(param1.attribute("namebase").length() > 0)
         {
            this.var_1503 = param1.@namebase;
         }
         else
         {
         ...
         {
            this.var_1485 = this._id;
         }
         if(param1.attribute("state_default").length() > 0)
         {
            this.var_1504 = param1.@state_default;
         }
         if(param1.attribute("tooltip").length() > 0)
         {
            this.var_2040 = param1.@tooltip;
         }
