package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2689:Number;
      
      private var var_2688:Number;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1485 = param1.nextState;
         this.var_1386 = param1.loop;
         if(param1.background != null)
         {
            this.var_900 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1386 == true || this.var_899 == 0)
         {
            if(this.var_902.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_902.length)
               {
                  this._frame = 0;
                  ++this.var_899;
               }
      ...
      {
         return this.var_902.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1386 == false && this.var_899 == 1 && this.var_1485 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_900.width),Math.max(param2.height,this.var_900.height));
            _loc3_.copyPixels(this.var_900,this.var_900.rect,new Point(0,0));
