package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1232:uint = 13232628;
      
      private static var var_1493:uint = 11129827;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1494 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_656)
         {
            this.var_656 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_656)
            {
               return;
            }
            this._window.content.addChild(this.var_656);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_656.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_444;
         }
         this.showView(this.var_656);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_939 || param1 == ChangeUserNameResultMessageEvent.var_940)
         {
