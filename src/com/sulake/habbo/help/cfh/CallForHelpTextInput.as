package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1219:int = 30;
      
      private static const const_1218:int = 253;
      
      private static const const_1220:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_180);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1219)
         {
