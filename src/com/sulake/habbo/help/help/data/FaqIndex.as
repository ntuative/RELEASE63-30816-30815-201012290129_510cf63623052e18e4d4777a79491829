package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_667:FaqCategory;
      ...
      {
         super();
         this.var_667 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_666 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_665 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_667.hasItem(param1))
         {
            this.var_667.getItem(param1).answerText = param2;
         }
         if(this.var_666.hasItem(param1))
         {
            this.var_666.getItem(param1).answerText = param2;
         }
         if(this.var_665.hasItem(param1))
         {
            this.var_665.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_667.hasItem(param1))
         {
            return this.var_667.getItem(param1);
         }
         if(this.var_666.hasItem(param1))
         {
            return this.var_666.getItem(param1);
         }
         if(this.var_665.hasItem(param1))
         {
            return this.var_665.getItem(param1);
         }
         var _loc2_:int = 0;
