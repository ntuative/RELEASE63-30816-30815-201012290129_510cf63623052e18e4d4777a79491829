package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_203 = FaqItem(param1);
         }
         if(this.var_203 == null)
         {
            return;
         }
         if(!this.var_203.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_203.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_203.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_203.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_203.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_203.index + 1);
         }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_203 != null)
         {
            _loc2_ = this.var_203.category;
            main.showUI(HabboHelpViewEnum.const_270);
            main.tellUI(HabboHelpViewEnum.const_270,_loc2_);
         }
      }
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_203 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_203.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_203.index + 1);
      }
   }
}
