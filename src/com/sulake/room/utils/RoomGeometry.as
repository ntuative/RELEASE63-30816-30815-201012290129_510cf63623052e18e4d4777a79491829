package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_587:Number = 64;
      
      public static const const_1026:Number = 32;
      ...
      private var var_1656:Number = 1.0;
      
      private var var_76:Vector3d;
      
      private var var_239:Vector3d;
      
      private var var_2672:Number = -500.0;
      
      private var var_2673:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1062 = new Vector3d();
         this.var_1655 = 1;
         this.var_1657 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1656 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_76.x * this.var_384,this.var_76.y * this.var_385,this.var_76.z * this.var_386);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_239.x,this.var_239.y,this.var_239.z);
      }
      ...
      {
         if(this.var_385 != param1 * this.var_1657)
         {
            this.var_385 = param1 * this.var_1657;
            ++this.var_144;
         }
      }
      ...
      {
         if(this.var_386 != param1 * this.var_1656)
         {
            this.var_386 = param1 * this.var_1656;
            ++this.var_144;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_76.x /= this.var_384;
         this.var_76.y /= this.var_385;
         this.var_76.z /= this.var_386;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_239.x;
         var _loc3_:Number = this.var_239.y;
         var _loc4_:Number = this.var_239.z;
         this.var_239.assign(param1);
         if(this.var_239.x != _loc2_ || this.var_239.y != _loc3_ || this.var_239.z != _loc4_)
         {
            ++this.var_144;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1062.assign(_loc22_);
         }
         else
         {
            this.var_1062.assign(_loc17_);
         }
         ++this.var_144;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1062);
         if(_loc3_ < this.var_2672 || _loc3_ > this.var_2673)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_385;
            _loc2_.z *= this.var_386;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1062);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_76.x * this.var_384,this.var_76.y * this.var_385,this.var_76.z * this.var_386);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1026;
         }
         else
         {
            this.scale = const_587;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_587;
      }
