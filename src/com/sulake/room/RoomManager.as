package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1071:int = 2;
      ...
      private var var_137:IRoomManagerListener;
      
      private var var_2705:IRoomContentLoader;
      
      private var var_535:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_534 = [];
         this.var_533 = [];
         events.addEventListener(RoomContentLoadedEvent.const_348,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_412,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_535 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_535 == null || this.var_443 == null)
         {
            return;
         }
         this._state = const_1300;
         if(this.var_984 != null)
         {
            _loc1_ = this.var_984;
            this.var_984 = null;
            this.initialize(_loc1_,this.var_137);
         }
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_535.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_535 != null)
         {
            return this.var_535.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_811)
         {
            return;
         }
         if(this.var_44 == null)
         {
            this._state = const_811;
            return;
         }
         if(this.var_44.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_534.length == 0)
            {
               ...
               {
                  this.var_137.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_811;
            this.var_137.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_137 != null)
            {
               this.var_137.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(this.var_137 != null)
            {
               this.var_137.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(this.var_137 != null)
         {
            this.var_137.contentLoaded(_loc2_,true);
         }
         if(this.var_534.length > 0)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_44 == null || this.var_443 == null)
         {
            return;
         }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_535.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_137 != null)
                                 {
                                    this.var_137.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
