package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private static var var_1033:int = 0;
      ...
      {
         this.var_1589.assign(this.var_76);
         return this.var_1589;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1588.assign(this.var_239);
      ...
      public function setDirection(param1:IVector3d) : void
      {
         ...
         if(this.var_239.x != param1.x || this.var_239.y != param1.y || this.var_239.z != param1.z)
         {
            this.var_239.x = (param1.x % 360 + 360) % 360;
            this.var_239.y = (param1.y % 360 + 360) % 360;
            this.var_239.z = (param1.z % 360 + 360) % 360;
            ++this._updateID;
         }
      }
