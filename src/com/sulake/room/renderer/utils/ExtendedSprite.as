package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1487 || param2 != this.var_1486)
         {
      ...
      {
         if(this.var_1227 > 255 || bitmapData == null)
         {
            return false;
         }
